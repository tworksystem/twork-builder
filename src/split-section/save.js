				...
				>
					<div className="fade-up split-section-text">
						...
						<RichText.Content
							tagName="h2"
							value={ title }
							className="split-section-title"
						/>
						<RichText.Content
							tagName="p"
							value={ description }
							className="split-section-description"
						/>
						<ul className="lap-list">
							{ items.map( ( item ) => (
								<li key={ item.id }>
									...
									/>
									<div>
										<h4 className="lap-list-title">
											{ item.title }
										</h4>
										<p className="lap-list-subtitle">
											{ item.subtitle }
										</p>
									</div>
								</li>
						...
						{ imageUrl && (
							<>
								...
								<div className="floating-badge">
									<i
										className={ badgeIcon || 'fas fa-star' }
										aria-hidden="true"
									/>
									<div>
										<strong className="floating-badge-title">
											{ badgeTitle }
										</strong>
										<span className="floating-badge-subtitle">
											{ badgeSubtitle }
										</span>
									</div>
								</div>
