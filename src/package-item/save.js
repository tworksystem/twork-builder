        ...
        <div {...blockProps}>
            ...
            <div className="pkg-body lab-price-body">
                <ul className="pkg-features lab-features">
                    {features &&
                        features.map((feat, index) => (
                            ...
                            >
                                <i
                                    className={feat.available ? 'fas fa-check' : 'fas fa-times'}
                                    style={{ color: feat.available ? featureIconColor : '#ccc' }}
                                    aria-hidden
                                />
                                {feat.text}
                            </li>
                ...
                {showButton && buttonText && (
                    <a
                        href={buttonUrl || '#'}
                        className={`jivaka-btn lab-btn ${buttonStyle === 'primary' ? '' : 'lab-btn-outline'}`}
                        target={buttonTarget ? '_blank' : '_self'}
                        rel={buttonRel || (buttonTarget ? 'noopener noreferrer' : undefined)}
                        style={{
                            backgroundColor: buttonStyle === 'primary' ? '#0284c7' : buttonBgColor,
