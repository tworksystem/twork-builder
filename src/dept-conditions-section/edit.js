...
const TEMPLATE = [
    ['twork/dept-condition-item', { icon: 'fa-heart-broken', title: 'Coronary Artery Disease' }],
    ['twork/dept-condition-item', { icon: 'fa-bolt', title: 'Arrhythmia' }],
    ['twork/dept-condition-item', { icon: 'fa-heartbeat', title: 'Heart Failure' }],
    ['twork/dept-condition-item', { icon: 'fa-child', title: 'Congenital Defects' }],
    ['twork/dept-condition-item', { icon: 'fa-procedures', title: 'Valvular Disease' }],
    ['twork/dept-condition-item', { icon: 'fa-user-md', title: 'Hypertension' }],
];

export default function Edit({ attributes, setAttributes }) {
    const { sectionId, title } = attributes;
    const blockProps = useBlockProps({ className: 'content-section twork-dept-conditions-editor' });
