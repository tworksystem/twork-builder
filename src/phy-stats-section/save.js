...
export default function save({ attributes }) {
    ...
    const blockProps = useBlockProps.save({
        ...
        style: {
            ...
            '--phy-stat-card-border-bottom': `${Number(cardBorderBottomWidth)}px solid ${primaryColor || DEFAULT_ATTS.primaryColor}`,
        },
        ...
        <div {...blockProps}>
            ...
            >
                <div
                    ...
                    style={{
                        display: 'grid',
                        gridTemplateColumns: `repeat(${Number(columns) || 4}, minmax(200px, 1fr))`,
