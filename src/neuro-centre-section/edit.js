    ...
    return (
        <>
            <InspectorControls>
                ...
                >
                    <ToggleControl
                        label={__('Show Sidebar (Clinical Centres + Emergency)', 'twork-builder')}
                    ...
                    <ToggleControl
                        ...
                        onChange={(val) => setAttributes({ showOverview: val })}
                    />
                    <ToggleControl
                        label={__('Show Treatments & Services', 'twork-builder')}
                        checked={showTreatments !== false}
                        onChange={(val) => setAttributes({ showTreatments: val })}
                        help={__('Treatment cards can be added, removed, or reordered using the + button below the grid and the block toolbar (⋮) on each card.', 'twork-builder')}
                    />
                    <ToggleControl
                        label={__('Show Specialists strip', 'twork-builder')}
                        checked={showSpecialists !== false}
                        onChange={(val) => setAttributes({ showSpecialists: val })}
                    />
                    <ToggleControl
                        label={__('Show FAQs', 'twork-builder')}
                        checked={showFaq !== false}
                        onChange={(val) => setAttributes({ showFaq: val })}
                    />
                    <ToggleControl
                    ...
                    />
                    <ToggleControl
                        label={__('Show Nearby Accommodation', 'twork-builder')}
                        checked={showNearbyAccommodation === true}
                        onChange={(val) => setAttributes({ showNearbyAccommodation: val })}
                        help={__('Add hotel/accommodation cards below CTA. Use "+" to add Twork Nearby Accommodation Item blocks.', 'twork-builder')}
                    />
                </PanelBody>
                ...
                >
                    <TextControl
                        ...
                        onChange={(val) => setAttributes({ nearbyAccommodationTitle: val })}
                        help={__('Heading shown above the accommodation cards.', 'twork-builder')}
                    />
                </PanelBody>
                ...
                >
                    ...
                    <TextControl
                        ...
                        help={__('Use absolute or relative URL.', 'twork-builder')}
                    />
                </PanelBody>
                        ...
                        <aside className="sidebar-wrapper sidebar-wrapper--placeholder">
                            <div className="sidebar sidebar--editor-note">
                                <div className="sidebar-header">
                                    {__('Clinical Centres Sidebar', 'twork-builder')}
                                </div>
                    ...
                    <div className="main-content">
                        ...
                        <div className="content-section">
                            <RichText
                                ...
                                placeholder={__('Overview title…', 'twork-builder')}
                            />
                            ...
                            <RichText
                                ...
                                placeholder={__('Body text…', 'twork-builder')}
                            />
                        ...
                        <div className="content-section fade-up neuro-treatments-section">
                            <RichText
                                ...
                                onChange={(val) =>
                                    setAttributes({ treatmentsTitle: val })
                                }
                                placeholder={__(
                                    'Treatments & Services',
                                    'twork-builder'
                            ...
                            <RichText
                                ...
                                onChange={(val) =>
                                    setAttributes({ treatmentsIntro: val })
                                }
                                placeholder={__(
                            ...
                            <div className="treatment-grid">
                                <InnerBlocks
                                    ...
                                    allowedBlocks={['twork/neuro-treatment-item']}
                                    template={[
                                        [
                                    ...
                                    placeholder={__('Add treatment card — use the + button to add, remove, or reorder.', 'twork-builder')}
                                />
                            </div>
                        </div>
                        )}
                        ...
                        <div className="content-section">
                            <div className="section-header--inline">
                                <RichText
                                    ...
                                    onChange={(val) =>
                                        setAttributes({ specialistsTitle: val })
                                    }
                                    placeholder={__(
                        ...
                        <div className="content-section neuro-faq-section">
                            ...
                            <div className="neuro-faq-list">
                                <InnerBlocks
                                    ...
                                    allowedBlocks={['twork/neuro-faq-item']}
                                    template={[
                                        [
                                    ...
                                    templateLock={false}
                                    renderAppender={InnerBlocks.ButtonBlockAppender}
                                    placeholder={__('Add FAQ item — use the + button to add, remove, or reorder questions.', 'twork-builder')}
                                />
                            </div>
                        </div>
                        )}
                        ...
                        <div className="content-section nearby-accommodation-in-section">
                            <RichText
                                ...
                                value={nearbyAccommodationTitle || ''}
                                onChange={(val) =>
                                    setAttributes({ nearbyAccommodationTitle: val })
                                }
                                placeholder={__('Nearby Accommodation', 'twork-builder')}
                            />
                            <div
                            ...
                            >
                                <InnerBlocks
                                    allowedBlocks={['twork/nearby-accommodation-item']}
                                    template={[
                                        ['twork/nearby-accommodation-item', {}],
                                    ]}
                                    templateLock={false}
                                    renderAppender={InnerBlocks.ButtonBlockAppender}
                                    placeholder={__('Add Nearby Accommodation Item — use the + button to add more hotel/accommodation cards.', 'twork-builder')}
                                />
                            </div>
                        </div>
                        )}
