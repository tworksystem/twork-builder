...
function TechItemMediaOutput({ mediaType, imageUrl, imageAlt, videoUrl, iconClass, dashicon, caption }) {
...
export default function save({ attributes }) {
    const { mediaType, imageUrl, imageAlt, videoUrl, iconClass, dashicon, caption } = attributes;
