...
export default function save({ attributes }) {
    ...
    const blockProps = useBlockProps.save({
        className: 'twork-inquiry-form-section inquiry-form-block section-padding services-section',
        style: {
                            ...
                            <ul style={{ marginTop: '20px', listStyle: 'none', padding: 0 }}>
                                {leftPhone && (
                                    <li style={{ marginBottom: '10px' }}>
                                        <i className="fas fa-phone-alt" style={{ marginRight: '8px' }} aria-hidden="true" />
                                        <span style={{ color: leftContactColor, fontSize: `${leftContactFontSize}rem` }}>{leftPhone}</span>
                                    </li>
                                )}
                                {leftEmail && (
                                    <li>
                                        <i className="fas fa-envelope" style={{ marginRight: '8px' }} aria-hidden="true" />
                    ...
                    <div className="form-container">
                        ...
                        >
                            <div className="form-group">
                                <label htmlFor="inquiry-fullname">{fullNameLabel}</label>
                                <input
                                    type="text"
                                    id="inquiry-fullname"
                                    name="fullname"
                            ...
                            <div className="form-row form-row-2col">
                                <div className="form-group">
                                    <label htmlFor="inquiry-country">{countryLabel}</label>
                                    <input
                                        type="text"
                                        id="inquiry-country"
                                        name="country"
                                ...
                                <div className="form-group">
                                    <label htmlFor="inquiry-phone">{phoneLabel}</label>
                                    <input
                                        type="text"
                                        id="inquiry-phone"
                                        name="phone"
                            ...
                            <div className="form-group">
                                <label htmlFor="inquiry-specialty">{specialtyLabel}</label>
                                <select id="inquiry-specialty" name="specialty" className="form-control">
