				...
				<InspectorControls>
						...
						>
							{ ! leftBackgroundImage ? (
								<MediaPlaceholder
									onSelect={ ( media ) =>
										setAttributes( {
											leftBackgroundImage: media.url,
											leftBackgroundImageId: media.id,
										} )
									}
									allowedTypes={ [ 'image' ] }
									multiple={ false }
					...
					>
						...
						<TextControl
							...
							onChange={ ( val ) =>
								setAttributes( { specialtyOptions: val } )
							}
							help={ __(
						...
						<TextControl
							...
							onChange={ ( val ) =>
								setAttributes( { submitButtonText: val } )
							}
						/>
					</PanelBody>
