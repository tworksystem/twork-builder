...
export default function Edit({ attributes, setAttributes }) {
    ...
    const TEMPLATE = [
        ['twork/stat-item', { statNumber: '50+', statLabel: 'Rural Medical Camps' }],
        ['twork/stat-item', { statNumber: '10k+', statLabel: 'Patients Screened' }],
        ['twork/stat-item', { statNumber: '200+', statLabel: 'Free Surgeries' }],
        ['twork/stat-item', { statNumber: '1.5k', statLabel: 'Units of Blood Donated' }]
    ];
        ...
        <>
            <InspectorControls>
                ...
                >
                    ...
                    <RangeControl
                        label={__('Section Max Width (px)', 'twork-builder')}
                        value={sectionMaxWidth}
                        onChange={(val) => setAttributes({ sectionMaxWidth: val })}
                        min={800}
                        max={1400}
                        step={10}
                        help={__('Max width of the stats card', 'twork-builder')}
                    />
                    ...
                    <RangeControl
                        ...
                        max={0}
                        step={5}
                        help={__('Negative value overlaps hero (e.g. -60)', 'twork-builder')}
                    />
                ...
                >
                    <RangeControl
                        ...
                        max={6}
                        step={1}
                        help={__('Number of stat columns on desktop', 'twork-builder')}
                    />
