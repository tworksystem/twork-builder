        ...
        <>
            <InspectorControls>
                <PanelBody title={__('Section', 'twork-builder')} initialOpen={true}>
                    ...
                    />
                    <RangeControl
                        label={__('FAQ list max width (px)', 'twork-builder')}
            ...
            <section {...blockProps}>
                <div className="hc-container" style={containerStyle}>
                    {showSectionTitle && (
                        <div className={`hc-header ${animationOnScroll ? animationType : ''}`} style={{ textAlign: 'center', marginBottom: 30 }}>
                            <RichText
                                tagName="h2"
                                value={sectionTitle}
                                onChange={(val) => setAttributes({ sectionTitle: val })}
                                placeholder={__('Frequently Asked Questions', 'twork-builder')}
