...
export default function save( { attributes } ) {
	...
	const blockProps = useBlockProps.save( {
		...
		style: {
			...
			'--item-border-width': enableItemBorder
				? `${ itemBorderWidth }px`
				: '0px',
			'--item-border-width-top': enableItemBorder
				? `${ itemBorderWidthTop || itemBorderWidth }px`
				: '0px',
			'--item-border-width-right': enableItemBorder
				? `${ itemBorderWidthRight || itemBorderWidth }px`
				: '0px',
			'--item-border-width-bottom': enableItemBorder
				? `${ itemBorderWidthBottom || itemBorderWidth }px`
				: '0px',
			'--item-border-width-left': enableItemBorder
				? `${ itemBorderWidthLeft || itemBorderWidth }px`
				: '0px',
			'--item-border-width-mobile': enableItemBorder
				? `${ itemBorderWidthMobile || itemBorderWidth }px`
				: '0px',
			'--item-border-color': itemBorderColor || '#e0e0e0',
			'--item-border-color-hover':
				itemBorderColorHover || itemBorderColor || '#e0e0e0',
		...
		'data-item-border-width-top': enableItemBorder
			? itemBorderWidthTop || itemBorderWidth
			: 0,
		'data-item-border-width-right': enableItemBorder
			? itemBorderWidthRight || itemBorderWidth
			: 0,
		'data-item-border-width-bottom': enableItemBorder
			? itemBorderWidthBottom || itemBorderWidth
			: 0,
		'data-item-border-width-left': enableItemBorder
			? itemBorderWidthLeft || itemBorderWidth
			: 0,
		'data-item-border-width-mobile': enableItemBorder
			? itemBorderWidthMobile || itemBorderWidth
			: 0,
