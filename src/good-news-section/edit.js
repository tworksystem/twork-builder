...
export default function Edit({ attributes, setAttributes }) {
    ...
    const gridStyle = {
        ...
        flexDirection: layoutDirection === 'content-right' ? 'row-reverse' : 'row',
        flexWrap: 'nowrap',
        width: '100%',
        ...
        '--grid-flex-direction-desktop': layoutDirection === 'content-right' ? 'row-reverse' : 'row',
    ...
    const contentWrapperStyle = {
        ...
        display: 'flex',
        alignItems: 'center',
        justifyContent: contentAlignment === 'center' ? 'center' : contentAlignment === 'right' ? 'flex-end' : 'flex-start',
        position: 'relative',
        zIndex: 10,
    ...
    const contentStyle = {
        ...
        width: '100%',
        marginRight: contentAlignment === 'left' ? `${contentMarginRight}%` : '0',
        marginLeft: contentAlignment === 'right' ? `${contentMarginRight}%` : '0',
    ...
    const imageBgStyle = {
        ...
        backgroundSize: getBackgroundSize(backgroundImageSize, backgroundImageCustomSize),
        ...
        '--image-max-width': imageMaxWidth > 0 ? `${imageMaxWidth}px` : 'none',
        '--image-max-width-tablet': imageMaxWidthTablet > 0 ? `${imageMaxWidthTablet}px` : 'none',
        '--image-max-width-mobile': imageMaxWidthMobile > 0 ? `${imageMaxWidthMobile}px` : 'none',
        '--image-max-height': imageMaxHeight > 0 ? `${imageMaxHeight}px` : 'none',
        '--image-max-height-tablet': imageMaxHeightTablet > 0 ? `${imageMaxHeightTablet}px` : 'none',
        '--image-max-height-mobile': imageMaxHeightMobile > 0 ? `${imageMaxHeightMobile}px` : 'none',
        ...
        '--background-size': getBackgroundSize(backgroundImageSize, backgroundImageCustomSize),
        '--background-size-tablet': getBackgroundSize(backgroundImageSizeTablet, backgroundImageCustomSizeTablet) || getBackgroundSize(backgroundImageSize, backgroundImageCustomSize),
        '--background-size-mobile': getBackgroundSize(backgroundImageSizeMobile, backgroundImageCustomSizeMobile) || getBackgroundSize(backgroundImageSizeTablet, backgroundImageCustomSizeTablet) || getBackgroundSize(backgroundImageSize, backgroundImageCustomSize),
        '--background-position': backgroundImagePosition,
        '--background-position-tablet': backgroundImagePositionTablet || backgroundImagePosition,
        '--background-position-mobile': backgroundImagePositionMobile || backgroundImagePositionTablet || backgroundImagePosition,
    ...
    const formGroupMarginTablet = getFormGroupMargin(formAlignmentTablet || formAlignment || contentAlignmentTablet || contentAlignment);
    const formGroupMarginMobile = getFormGroupMargin(formAlignmentMobile || formAlignment || contentAlignmentMobile || contentAlignment);
    ...
    const emailInputStyle = {
        ...
        '--email-placeholder-color-tablet': emailPlaceholderColorTablet || emailPlaceholderColor,
        '--email-placeholder-color-mobile': emailPlaceholderColorMobile || emailPlaceholderColor,
        '--email-border-color': emailBorderColor,
        '--email-border-color-tablet': emailBorderColorTablet || emailBorderColor,
        '--email-border-color-mobile': emailBorderColorMobile || emailBorderColor,
        ...
        '--email-focus-border-tablet': emailFocusBorderColorTablet || emailFocusBorderColor,
        '--email-focus-border-mobile': emailFocusBorderColorMobile || emailFocusBorderColor
    };
    ...
    const buttonStyle = {
        ...
        '--button-text-transform-tablet': buttonTextTransformTablet || buttonTextTransform,
        '--button-text-transform-mobile': buttonTextTransformMobile || buttonTextTransform,
        ...
        '--button-hover-bg-tablet': buttonHoverBgColorTablet || buttonHoverBgColor,
        '--button-hover-bg-mobile': buttonHoverBgColorMobile || buttonHoverBgColor,
                    ...
                    elements.push(
                        <span 
                            ...
                            style={{
                                ...
                                display: 'block',
                                lineHeight: 1,
                                '--highlight-font-weight-tablet': highlightFontWeightTablet,
                                '--highlight-font-weight-mobile': highlightFontWeightMobile,
                                '--highlight-font-size-tablet': `${highlightFontSizeTablet}em`,
                                '--highlight-font-size-mobile': `${highlightFontSizeMobile}em`,
                                '--highlight-color-tablet': highlightColorTablet || highlightColor,
                                '--highlight-color-mobile': highlightColorMobile || highlightColor
                            }}
                        >
                            {match.text}
                        </span>
        ...
        <>
            <InspectorControls>
                ...
                >
                    ...
                    <BaseControl label={__('Section Padding', 'twork-builder')}>
                        <RangeControl
                            label={__('Padding Top - Desktop (px)', 'twork-builder')}
                            value={paddingTop}
                        ...
                        />
                        <RangeControl
                            label={__('Padding Top - Tablet (px)', 'twork-builder')}
                            value={paddingTopTablet}
                            onChange={(val) => setAttributes({ paddingTopTablet: val })}
                            min={0}
                            max={150}
                            step={5}
                        />
                        ...
                        <Divider />
                        <RangeControl
                            label={__('Padding Bottom - Desktop (px)', 'twork-builder')}
                            value={paddingBottom}
                        ...
                        />
                        <RangeControl
                            label={__('Padding Bottom - Tablet (px)', 'twork-builder')}
                            value={paddingBottomTablet}
                            onChange={(val) => setAttributes({ paddingBottomTablet: val })}
                            min={0}
                            max={150}
                            step={5}
                        />
                ...
                >
                    <SelectControl
                        ...
                        onChange={(val) => setAttributes({ layoutDirection: val })}
                    />

                    <Divider />

                    <BaseControl label={__('Desktop Widths (%)', 'twork-builder')}>
                        <RangeControl
                            label={__('Content Width (%)', 'twork-builder')}
                            value={contentWidth}
                            onChange={(val) => {
                        ...
                        />
                        <RangeControl
                            label={__('Image Width (%)', 'twork-builder')}
                            value={imageWidth}
                            onChange={(val) => {
                                setAttributes({ imageWidth: val });
                                setAttributes({ contentWidth: 100 - val });
                            }}
                            min={30}
                            max={70}
                            step={5}
                    ...
                    <BaseControl label={__('Tablet Widths (%)', 'twork-builder')}>
                        <RangeControl
                            label={__('Content Width (%)', 'twork-builder')}
                            value={contentWidthTablet}
                            onChange={(val) => setAttributes({ contentWidthTablet: val })}
                            min={50}
                            max={100}
                            step={5}
                        />
                        <RangeControl
                            ...
                            onChange={(val) => setAttributes({ imageWidthTablet: val })}
                            min={50}
                            max={100}
                            step={5}
                        />
                    ...
                    <BaseControl label={__('Mobile Widths (%)', 'twork-builder')}>
                        <RangeControl
                            label={__('Content Width (%)', 'twork-builder')}
                            value={contentWidthMobile}
                            onChange={(val) => setAttributes({ contentWidthMobile: val })}
                            min={50}
                            max={100}
                            step={5}
                        />
                ...
                <PanelBody
                    ...
                    initialOpen={false}
                >
                    <BaseControl label={__('Desktop Image', 'twork-builder')}>
                        {!backgroundImage ? (
                            <MediaPlaceholder
                                ...
                                allowedTypes={['image']}
                                multiple={false}
                                labels={{ title: __('Desktop Background Image', 'twork-builder') }}
                            />
                        ) : (
                            <div>
                                <img
                    ...
                    <BaseControl>
                        <ToggleControl
                            label={__('Use Different Images for Responsive Views', 'twork-builder')}
                            checked={useResponsiveImages}
                            onChange={(val) => setAttributes({ useResponsiveImages: val })}
                            help={__('Enable to set separate images for tablet and mobile devices. When disabled, the desktop image will be used for all screen sizes.', 'twork-builder')}
                        />
                    </BaseControl>
                    ...
                    {useResponsiveImages && (
                        <>
                            ...
                            <BaseControl 
                                label={__('Tablet Image (992px and below)', 'twork-builder')}
                                help={__('Image displayed on tablet devices (max-width: 992px). If not set, the desktop image will be used as fallback.', 'twork-builder')}
                            >
                                {!backgroundImageTablet ? (
                                    <MediaPlaceholder
                                        onSelect={(media) => setAttributes({
                                            backgroundImageTablet: media.url,
                                            backgroundImageTabletId: media.id
                                        })}
                                        allowedTypes={['image']}
                                        multiple={false}
                                        labels={{ 
                                            title: __('Tablet Background Image', 'twork-builder'),
                                            instructions: __('Upload an image optimized for tablet devices (992px and below).', 'twork-builder')
                                        }}
                                    />
                                ) : (
                                    <div style={{ marginTop: '8px' }}>
                                        <img
                                            ...
                                            alt={__('Tablet background image preview', 'twork-builder')}
                                            style={{ 
                                                width: '100%', 
                                                height: 'auto', 
                                                marginBottom: '12px', 
                                        ...
                                        <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
                                            <MediaPlaceholder
                                                ...
                                                allowedTypes={['image']}
                                                multiple={false}
                                                labels={{ title: __('Replace Tablet Image', 'twork-builder') }}
                                            >
                                                <Button
                                                    isSecondary
                                                    isSmall
                            ...
                            <BaseControl 
                                label={__('Mobile Image (768px and below)', 'twork-builder')}
                                help={__('Image displayed on mobile devices (max-width: 768px). Falls back to tablet image (if available) or desktop image if not set.', 'twork-builder')}
                            >
                                {!backgroundImageMobile ? (
                                    <MediaPlaceholder
                                        onSelect={(media) => setAttributes({
                                            backgroundImageMobile: media.url,
                                            backgroundImageMobileId: media.id
                                        })}
                                        allowedTypes={['image']}
                                        multiple={false}
                                        labels={{ 
                                            title: __('Mobile Background Image', 'twork-builder'),
                                            instructions: __('Upload an image optimized for mobile devices (768px and below).', 'twork-builder')
                                        }}
                                    />
                                ) : (
                                    <div style={{ marginTop: '8px' }}>
                                        <img
                                            ...
                                            alt={__('Mobile background image preview', 'twork-builder')}
                                            style={{ 
                                                width: '100%', 
                                                height: 'auto', 
                                                marginBottom: '12px', 
                                        ...
                                        <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
                                            <MediaPlaceholder
                                                ...
                                                allowedTypes={['image']}
                                                multiple={false}
                                                labels={{ title: __('Replace Mobile Image', 'twork-builder') }}
                                            >
                                                <Button
                                                    isSecondary
                                                    isSmall
                        ...
                        <>
                            ...
                            <SelectControl
                                ...
                                options={[
                                    ...
                                    { label: __('Center Right', 'twork-builder'), value: 'center right' },
                                    { label: __('Center Left', 'twork-builder'), value: 'center left' },
                            ...
                            <BaseControl label={__('Background Size', 'twork-builder')}>
                                <SelectControl
                                    ...
                                    options={[
                                        ...
                                        { label: __('100% (Full Size)', 'twork-builder'), value: '100%' },
                                ...
                                {backgroundImageSize === 'custom' && (
                                    <TextControl
                                        label={__('Custom Size (e.g., 80% 60%, 1200px auto)', 'twork-builder')}
                                        value={backgroundImageCustomSize}
                                        onChange={(val) => setAttributes({ backgroundImageCustomSize: val })}
                                        placeholder={__('e.g., 80% 60%', 'twork-builder')}
                                        help={__('Width and height, separated by space', 'twork-builder')}
                                    />
                                )}
                                <SelectControl
                                    ...
                                    onChange={(val) => setAttributes({ backgroundImageSizeTablet: val })}
                                />
                                {backgroundImageSizeTablet === 'custom' && (
                                    <TextControl
                                        label={__('Custom Size - Tablet', 'twork-builder')}
                                        value={backgroundImageCustomSizeTablet}
                                        onChange={(val) => setAttributes({ backgroundImageCustomSizeTablet: val })}
                                        placeholder={__('e.g., 100% auto', 'twork-builder')}
                                    />
                                )}
                                <SelectControl
                                    ...
                                    onChange={(val) => setAttributes({ backgroundImageSizeMobile: val })}
                                />
                                {backgroundImageSizeMobile === 'custom' && (
                                    <TextControl
                                        label={__('Custom Size - Mobile', 'twork-builder')}
                                        value={backgroundImageCustomSizeMobile}
                                        onChange={(val) => setAttributes({ backgroundImageCustomSizeMobile: val })}
                                        placeholder={__('e.g., 100% auto', 'twork-builder')}
                                    />
                                )}
                            </BaseControl>
                            ...
                            <BaseControl label={__('Background Position', 'twork-builder')}>
                                <SelectControl
                                    label={__('Desktop', 'twork-builder')}
                                    value={backgroundImagePosition}
                                    options={[
                                        { label: __('Center', 'twork-builder'), value: 'center' },
                                        { label: __('Center Top', 'twork-builder'), value: 'center top' },
                                        { label: __('Center Bottom', 'twork-builder'), value: 'center bottom' },
                                        { label: __('Center Left', 'twork-builder'), value: 'center left' },
                                        { label: __('Center Right', 'twork-builder'), value: 'center right' },
                                        { label: __('Top', 'twork-builder'), value: 'top' },
                                        { label: __('Bottom', 'twork-builder'), value: 'bottom' },
                                ...
                                <SelectControl
                                    ...
                                    onChange={(val) => setAttributes({ backgroundImagePositionTablet: val })}
                                />
                                <SelectControl
                                    label={__('Mobile', 'twork-builder')}
                                    ...
                                    onChange={(val) => setAttributes({ backgroundImagePositionMobile: val })}
                                />
                            </BaseControl>
                            ...
                            <ToggleControl
                                ...
                                onChange={(val) => setAttributes({ showBackgroundOverlay: val })}
                            />
                            ...
                            <BaseControl label={__('Image Dimensions', 'twork-builder')}>
                                <h4 style={{ margin: '10px 0 5px 0', fontSize: '13px', fontWeight: 600 }}>
                                    {__('Minimum Height', 'twork-builder')}
                                </h4>
                                <RangeControl
                                    label={__('Desktop Min Height (px)', 'twork-builder')}
                                    value={imageMinHeight}
                                    onChange={(val) => setAttributes({ imageMinHeight: val })}
                                    min={200}
                                    max={800}
                                    step={10}
                                />
                                <RangeControl
                                    label={__('Tablet Min Height (px)', 'twork-builder')}
                                    value={imageMinHeightTablet}
                                    onChange={(val) => setAttributes({ imageMinHeightTablet: val })}
                                    min={200}
                                    max={600}
                                    step={10}
                                />
                                <RangeControl
                                    label={__('Mobile Min Height (px)', 'twork-builder')}
                                    value={imageMinHeightMobile}
                                    onChange={(val) => setAttributes({ imageMinHeightMobile: val })}
                                    min={150}
                                    max={400}
                                    step={10}
                                />
                                <Divider />
                                <h4 style={{ margin: '10px 0 5px 0', fontSize: '13px', fontWeight: 600 }}>
                                    {__('Maximum Width (0 = no limit)', 'twork-builder')}
                                </h4>
                                <RangeControl
                                    ...
                                    max={1920}
                                    step={10}
                                    help={__('Set to 0 for no limit', 'twork-builder')}
                                />
                                <RangeControl
                                    label={__('Tablet Max Width (px)', 'twork-builder')}
                                    value={imageMaxWidthTablet}
                                    onChange={(val) => setAttributes({ imageMaxWidthTablet: val })}
                                    min={0}
                                    max={1200}
                                    step={10}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ imageMaxWidthMobile: val })}
                                    min={0}
                                    max={768}
                                    step={10}
                                />
                                <Divider />
                                <h4 style={{ margin: '10px 0 5px 0', fontSize: '13px', fontWeight: 600 }}>
                                    {__('Maximum Height (0 = no limit)', 'twork-builder')}
                                </h4>
                                <RangeControl
                                    label={__('Desktop Max Height (px)', 'twork-builder')}
                                    value={imageMaxHeight}
                                    onChange={(val) => setAttributes({ imageMaxHeight: val })}
                                    min={0}
                                    max={1200}
                                    step={10}
                                    help={__('Set to 0 for no limit', 'twork-builder')}
                                />
                                <RangeControl
                                    label={__('Tablet Max Height (px)', 'twork-builder')}
                                    value={imageMaxHeightTablet}
                                    onChange={(val) => setAttributes({ imageMaxHeightTablet: val })}
                                    min={0}
                                    max={800}
                                    step={10}
                                />
                                <RangeControl
                                    label={__('Mobile Max Height (px)', 'twork-builder')}
                                    value={imageMaxHeightMobile}
                                    onChange={(val) => setAttributes({ imageMaxHeightMobile: val })}
                                    min={0}
                                    max={600}
                                    step={10}
                                />
                            ...
                            <BaseControl label={__('Image Display Settings', 'twork-builder')}>
                                <SelectControl
                                    ...
                                    help={__('How the image should be resized to fit its container', 'twork-builder')}
                                />
                                ...
                                <SelectControl
                                    ...
                                    help={__('Position of the image within its container', 'twork-builder')}
                                />
                                ...
                                <SelectControl
                                    ...
                                    onChange={(val) => setAttributes({ imageOverflow: val })}
                                />

                                <TextControl
                                    label={__('Aspect Ratio', 'twork-builder')}
                                    value={imageAspectRatio}
                                    onChange={(val) => setAttributes({ imageAspectRatio: val })}
                                    placeholder={__('e.g., 16/9, 4/3, 1/1', 'twork-builder')}
                                    help={__('Optional: Set aspect ratio (e.g., 16/9). Leave empty for auto.', 'twork-builder')}
                                />
                            </BaseControl>
                            ...
                            <PanelBody
                                title={__('Image Spacing (Margin & Padding)', 'twork-builder')}
                                initialOpen={false}
                            >
                                <BaseControl label={__('Margin - Desktop', 'twork-builder')}>
                                    <RangeControl
                                        label={__('Top (px)', 'twork-builder')}
                                        value={imageMarginTop}
                                        onChange={(val) => setAttributes({ imageMarginTop: val })}
                                        min={-100}
                                        max={100}
                                        step={5}
                                    />
                                    <RangeControl
                                        label={__('Right (px)', 'twork-builder')}
                                        value={imageMarginRight}
                                        onChange={(val) => setAttributes({ imageMarginRight: val })}
                                        min={-100}
                                        max={100}
                                        step={5}
                                    />
                                    <RangeControl
                                        label={__('Bottom (px)', 'twork-builder')}
                                    ...
                                    />
                                    <RangeControl
                                        label={__('Left (px)', 'twork-builder')}
                                        value={imageMarginLeft}
                                        onChange={(val) => setAttributes({ imageMarginLeft: val })}
                                        min={-100}
                                        max={100}
                                        step={5}
                                    />
                                ...
                                <BaseControl label={__('Margin - Tablet', 'twork-builder')}>
                                    <RangeControl
                                        label={__('Top (px)', 'twork-builder')}
                                        value={imageMarginTopTablet}
                                        onChange={(val) => setAttributes({ imageMarginTopTablet: val })}
                                        min={-100}
                                        max={100}
                                        step={5}
                                    />
                                    <RangeControl
                                        ...
                                        onChange={(val) => setAttributes({ imageMarginRightTablet: val })}
                                        min={-100}
                                        max={100}
                                        step={5}
                                    />
                                    <RangeControl
                                        ...
                                        onChange={(val) => setAttributes({ imageMarginBottomTablet: val })}
                                        min={-100}
                                        max={100}
                                        step={5}
                                    />
                                    <RangeControl
                                        ...
                                        onChange={(val) => setAttributes({ imageMarginLeftTablet: val })}
                                        min={-100}
                                        max={100}
                                        step={5}
                                    />
                                ...
                                <BaseControl label={__('Margin - Mobile', 'twork-builder')}>
                                    <RangeControl
                                        label={__('Top (px)', 'twork-builder')}
                                        value={imageMarginTopMobile}
                                        onChange={(val) => setAttributes({ imageMarginTopMobile: val })}
                                        min={-100}
                                        max={100}
                                        step={5}
                                    />
                                    <RangeControl
                                        ...
                                        onChange={(val) => setAttributes({ imageMarginRightMobile: val })}
                                        min={-100}
                                        max={100}
                                        step={5}
                                    />
                                    ...
                                    <RangeControl
                                        ...
                                        onChange={(val) => setAttributes({ imageMarginLeftMobile: val })}
                                        min={-100}
                                        max={100}
                                        step={5}
                                    />
                                ...
                                <BaseControl label={__('Padding - Desktop', 'twork-builder')}>
                                    <RangeControl
                                        label={__('Top (px)', 'twork-builder')}
                                        value={imagePaddingTop}
                                        onChange={(val) => setAttributes({ imagePaddingTop: val })}
                                        min={0}
                                        max={200}
                                        step={5}
                                    />
                                    <RangeControl
                                        ...
                                        onChange={(val) => setAttributes({ imagePaddingRight: val })}
                                        min={0}
                                        max={200}
                                        step={5}
                                    />
                                    <RangeControl
                                        ...
                                        onChange={(val) => setAttributes({ imagePaddingBottom: val })}
                                        min={0}
                                        max={200}
                                        step={5}
                                    />
                                    <RangeControl
                                        ...
                                        onChange={(val) => setAttributes({ imagePaddingLeft: val })}
                                        min={0}
                                        max={200}
                                        step={5}
                                    />
                                ...
                                <BaseControl label={__('Padding - Tablet', 'twork-builder')}>
                                    <RangeControl
                                        label={__('Top (px)', 'twork-builder')}
                                        value={imagePaddingTopTablet}
                                        onChange={(val) => setAttributes({ imagePaddingTopTablet: val })}
                                        min={0}
                                        max={150}
                                        step={5}
                                    />
                                    <RangeControl
                                        ...
                                        onChange={(val) => setAttributes({ imagePaddingRightTablet: val })}
                                        min={0}
                                        max={150}
                                        step={5}
                                    />
                                    <RangeControl
                                        ...
                                        onChange={(val) => setAttributes({ imagePaddingBottomTablet: val })}
                                        min={0}
                                        max={150}
                                        step={5}
                                    />
                                    <RangeControl
                                        ...
                                        onChange={(val) => setAttributes({ imagePaddingLeftTablet: val })}
                                        min={0}
                                        max={150}
                                        step={5}
                                    />
                                ...
                                <BaseControl label={__('Padding - Mobile', 'twork-builder')}>
                                    <RangeControl
                                        label={__('Top (px)', 'twork-builder')}
                                        value={imagePaddingTopMobile}
                                        onChange={(val) => setAttributes({ imagePaddingTopMobile: val })}
                                        min={0}
                                        max={100}
                                        step={5}
                                    />
                                    <RangeControl
                                        ...
                                        onChange={(val) => setAttributes({ imagePaddingRightMobile: val })}
                                        min={0}
                                        max={100}
                                        step={5}
                                    />
                                    <RangeControl
                                        ...
                                        onChange={(val) => setAttributes({ imagePaddingBottomMobile: val })}
                                        min={0}
                                        max={100}
                                        step={5}
                                    />
                                    <RangeControl
                                        ...
                                        onChange={(val) => setAttributes({ imagePaddingLeftMobile: val })}
                                        min={0}
                                        max={100}
                                        step={5}
                                    />
                ...
                >
                    <PanelColorSettings
                        title={__('Content Background', 'twork-builder')}
                        colorSettings={[
                            {
                    ...
                    <BaseControl label={__('Content Padding', 'twork-builder')}>
                        <RangeControl
                        ...
                        <RangeControl
                            ...
                            onChange={(val) => setAttributes({ contentPaddingTablet: val })}
                            min={20}
                            max={100}
                            step={5}
                        />
                        <RangeControl
                            ...
                            onChange={(val) => setAttributes({ contentPaddingMobile: val })}
                            min={20}
                            max={80}
                            step={5}
                        />
                    ...
                    <RangeControl
                        label={__('Content Max Width (px)', 'twork-builder')}
                    ...
                    <BaseControl label={__('Content Margin', 'twork-builder')}>
                        <RangeControl
                            label={__('Desktop Margin Right (%)', 'twork-builder')}
                            value={contentMarginRight}
                            onChange={(val) => setAttributes({ contentMarginRight: val })}
                            min={0}
                            max={20}
                            step={1}
                            help={__('Only applies when alignment is left', 'twork-builder')}
                        />
                        <RangeControl
                            label={__('Tablet Margin Right (%)', 'twork-builder')}
                            value={contentMarginRightTablet}
                            onChange={(val) => setAttributes({ contentMarginRightTablet: val })}
                            min={0}
                            max={20}
                            step={1}
                        />
                        <RangeControl
                            label={__('Mobile Margin Right (%)', 'twork-builder')}
                            value={contentMarginRightMobile}
                            onChange={(val) => setAttributes({ contentMarginRightMobile: val })}
                            min={0}
                            max={20}
                            step={1}
                        />
                    ...
                    <BaseControl label={__('Content Alignment', 'twork-builder')}>
                        <SelectControl
                            label={__('Desktop', 'twork-builder')}
                        ...
                        <SelectControl
                            ...
                            onChange={(val) => setAttributes({ contentAlignmentTablet: val })}
                        />
                        <SelectControl
                            label={__('Mobile', 'twork-builder')}
                            ...
                            onChange={(val) => setAttributes({ contentAlignmentMobile: val })}
                        />
                    </BaseControl>
                </PanelBody>
                ...
                >
                    <ToggleControl
                        ...
                        onChange={(val) => setAttributes({ showMetaTitle: val })}
                    />

                    {showMetaTitle && (
                        <>
                            <TextControl
                                label={__('Meta Title Text', 'twork-builder')}
                                value={metaTitle}
                                onChange={(val) => setAttributes({ metaTitle: val })}
                            />

                            <PanelColorSettings
                                title={__('Meta Title Color', 'twork-builder')}
                                colorSettings={[
                                    {
                                        value: metaTitleColor,
                                        onChange: (val) => setAttributes({ metaTitleColor: val }),
                                        label: __('Color', 'twork-builder')
                                    }
                                ]}
                            />

                            <BaseControl label={__('Font Size', 'twork-builder')}>
                                <RangeControl
                                    label={__('Desktop (rem)', 'twork-builder')}
                                    value={metaTitleFontSize}
                                    onChange={(val) => setAttributes({ metaTitleFontSize: val })}
                                    min={0.5}
                                    max={2}
                                    step={0.05}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ metaTitleFontSizeTablet: val })}
                                    min={0.5}
                                    max={1.8}
                                    step={0.05}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ metaTitleFontSizeMobile: val })}
                                    min={0.5}
                                    max={1.5}
                                    step={0.05}
                                />
                            ...
                            <BaseControl label={__('Font Weight', 'twork-builder')}>
                                <RangeControl
                                    label={__('Desktop', 'twork-builder')}
                                    value={metaTitleFontWeight}
                                    onChange={(val) => setAttributes({ metaTitleFontWeight: val })}
                                    min={100}
                                    max={900}
                                    step={100}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ metaTitleFontWeightTablet: val })}
                                    min={100}
                                    max={900}
                                    step={100}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ metaTitleFontWeightMobile: val })}
                                    min={100}
                                    max={900}
                                    step={100}
                                />
                            ...
                            <BaseControl label={__('Text Color', 'twork-builder')}>
                                <PanelColorSettings
                                    title={__('Desktop', 'twork-builder')}
                                    colorSettings={[
                                        {
                                            value: metaTitleColor,
                                            onChange: (val) => setAttributes({ metaTitleColor: val }),
                                ...
                                />
                                <PanelColorSettings
                                    title={__('Tablet', 'twork-builder')}
                                    colorSettings={[
                                        {
                                            value: metaTitleColorTablet || metaTitleColor,
                                            onChange: (val) => setAttributes({ metaTitleColorTablet: val || '' }),
                                            label: __('Color (Tablet)', 'twork-builder')
                                        }
                                    ]}
                                />
                                <PanelColorSettings
                                    ...
                                    colorSettings={[
                                        {
                                            value: metaTitleColorMobile || metaTitleColor,
                                            onChange: (val) => setAttributes({ metaTitleColorMobile: val || '' }),
                                            label: __('Color (Mobile)', 'twork-builder')
                                        }
                                    ]}
                                />
                            </BaseControl>
                            ...
                            <BaseControl label={__('Text Transform', 'twork-builder')}>
                                <SelectControl
                                    label={__('Desktop', 'twork-builder')}
                                    ...
                                    onChange={(val) => setAttributes({ metaTitleTextTransform: val })}
                                />
                                <SelectControl
                                    label={__('Tablet', 'twork-builder')}
                                    value={metaTitleTextTransformTablet || metaTitleTextTransform}
                                    options={[
                                        { label: __('Use Desktop', 'twork-builder'), value: '' },
                                        { label: __('None', 'twork-builder'), value: 'none' },
                                        { label: __('Uppercase', 'twork-builder'), value: 'uppercase' },
                                        { label: __('Lowercase', 'twork-builder'), value: 'lowercase' },
                                        { label: __('Capitalize', 'twork-builder'), value: 'capitalize' }
                                    ]}
                                    onChange={(val) => setAttributes({ metaTitleTextTransformTablet: val || '' })}
                                />
                                <SelectControl
                                    label={__('Mobile', 'twork-builder')}
                                    value={metaTitleTextTransformMobile || metaTitleTextTransform}
                                    options={[
                                        { label: __('Use Desktop', 'twork-builder'), value: '' },
                                        { label: __('None', 'twork-builder'), value: 'none' },
                                        { label: __('Uppercase', 'twork-builder'), value: 'uppercase' },
                                    ...
                                    onChange={(val) => setAttributes({ metaTitleTextTransformMobile: val || '' })}
                                />
                            </BaseControl>

                            <Divider />

                            <BaseControl label={__('Letter Spacing (px)', 'twork-builder')}>
                                <RangeControl
                                    label={__('Desktop', 'twork-builder')}
                                    value={metaTitleLetterSpacing}
                                    onChange={(val) => setAttributes({ metaTitleLetterSpacing: val })}
                                    min={0}
                                    max={5}
                                    step={0.1}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ metaTitleLetterSpacingTablet: val })}
                                    min={0}
                                    max={5}
                                    step={0.1}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ metaTitleLetterSpacingMobile: val })}
                                    min={0}
                                    max={5}
                                    step={0.1}
                                />
                            ...
                            <BaseControl label={__('Margin (px)', 'twork-builder')}>
                                <h4 style={{ margin: '10px 0 5px 0', fontSize: '13px', fontWeight: 600 }}>
                                ...
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ metaTitleMarginTop: val })}
                                    min={0}
                                    max={100}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ metaTitleMarginRight: val })}
                                    min={0}
                                    max={100}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ metaTitleMarginBottom: val })}
                                    min={0}
                                    max={100}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ metaTitleMarginLeft: val })}
                                    min={0}
                                    max={100}
                                    step={5}
                                />
                                ...
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ metaTitleMarginTopTablet: val })}
                                    min={0}
                                    max={80}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ metaTitleMarginRightTablet: val })}
                                    min={0}
                                    max={80}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ metaTitleMarginBottomTablet: val })}
                                    min={0}
                                    max={80}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ metaTitleMarginLeftTablet: val })}
                                    min={0}
                                    max={80}
                                    step={5}
                                />
                                ...
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ metaTitleMarginTopMobile: val })}
                                    min={0}
                                    max={60}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ metaTitleMarginRightMobile: val })}
                                    min={0}
                                    max={60}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ metaTitleMarginBottomMobile: val })}
                                    min={0}
                                    max={60}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ metaTitleMarginLeftMobile: val })}
                                    min={0}
                                    max={60}
                                    step={5}
                                />
                            ...
                            <BaseControl label={__('Padding (px)', 'twork-builder')}>
                                <h4 style={{ margin: '10px 0 5px 0', fontSize: '13px', fontWeight: 600 }}>
                                    {__('Desktop', 'twork-builder')}
                                </h4>
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ metaTitlePaddingTop: val })}
                                    min={0}
                                    max={50}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ metaTitlePaddingRight: val })}
                                    min={0}
                                    max={50}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ metaTitlePaddingBottom: val })}
                                    min={0}
                                    max={50}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ metaTitlePaddingLeft: val })}
                                    min={0}
                                    max={50}
                                    step={5}
                                />
                                ...
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ metaTitlePaddingTopTablet: val })}
                                    min={0}
                                    max={40}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ metaTitlePaddingRightTablet: val })}
                                    min={0}
                                    max={40}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ metaTitlePaddingBottomTablet: val })}
                                    min={0}
                                    max={40}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ metaTitlePaddingLeftTablet: val })}
                                    min={0}
                                    max={40}
                                    step={5}
                                />
                                ...
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ metaTitlePaddingTopMobile: val })}
                                    min={0}
                                    max={30}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ metaTitlePaddingRightMobile: val })}
                                    min={0}
                                    max={30}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ metaTitlePaddingBottomMobile: val })}
                                    min={0}
                                    max={30}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ metaTitlePaddingLeftMobile: val })}
                                    min={0}
                                    max={30}
                                    step={5}
                                />
                            ...
                            <BaseControl label={__('Text Alignment', 'twork-builder')}>
                                <SelectControl
                                    label={__('Desktop', 'twork-builder')}
                                    value={metaTitleAlignment}
                                    options={[
                                        { label: __('Inherit from Content', 'twork-builder'), value: '' },
                                        { label: __('Left', 'twork-builder'), value: 'left' },
                                        { label: __('Center', 'twork-builder'), value: 'center' },
                                        { label: __('Right', 'twork-builder'), value: 'right' }
                                    ]}
                                    onChange={(val) => setAttributes({ metaTitleAlignment: val || '' })}
                                />
                                <SelectControl
                                    label={__('Tablet', 'twork-builder')}
                                    value={metaTitleAlignmentTablet || metaTitleAlignment}
                                    options={[
                                        { label: __('Use Desktop', 'twork-builder'), value: '' },
                                        { label: __('Inherit from Content', 'twork-builder'), value: 'inherit' },
                                        { label: __('Left', 'twork-builder'), value: 'left' },
                                        { label: __('Center', 'twork-builder'), value: 'center' },
                                        { label: __('Right', 'twork-builder'), value: 'right' }
                                    ]}
                                    onChange={(val) => setAttributes({ metaTitleAlignmentTablet: val || '' })}
                                />
                                <SelectControl
                                    label={__('Mobile', 'twork-builder')}
                                    value={metaTitleAlignmentMobile || metaTitleAlignment}
                                    options={[
                                        { label: __('Use Desktop', 'twork-builder'), value: '' },
                                        { label: __('Inherit from Content', 'twork-builder'), value: 'inherit' },
                                        { label: __('Left', 'twork-builder'), value: 'left' },
                                    ...
                                    onChange={(val) => setAttributes({ metaTitleAlignmentMobile: val || '' })}
                                />
                            </BaseControl>
                        </>
                    )}
                ...
                >
                    ...
                    {showHeading && (
                        <>
                            <TextControl
                                label={__('Heading Text', 'twork-builder')}
                                value={heading}
                            ...
                            <BaseControl label={__('Font Size', 'twork-builder')}>
                                ...
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ headingFontSizeTablet: val })}
                                    min={1.5}
                                    max={4.5}
                                    step={0.1}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ headingFontSizeMobile: val })}
                                    min={1.5}
                                    max={3.5}
                                    step={0.1}
                                />
                            ...
                            <BaseControl label={__('Text Color', 'twork-builder')}>
                                ...
                                <PanelColorSettings
                                    ...
                                    colorSettings={[
                                        {
                                            value: headingColorTablet || headingColor,
                                            onChange: (val) => setAttributes({ headingColorTablet: val || '' }),
                                            label: __('Color (Tablet)', 'twork-builder')
                                        }
                                    ]}
                                />
                                <PanelColorSettings
                                    ...
                                    colorSettings={[
                                        {
                                            value: headingColorMobile || headingColor,
                                            onChange: (val) => setAttributes({ headingColorMobile: val || '' }),
                                            label: __('Color (Mobile)', 'twork-builder')
                                        }
                                    ]}
                                />
                            ...
                            <BaseControl label={__('Font Weight', 'twork-builder')}>
                                ...
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ headingFontWeightTablet: val })}
                                    min={100}
                                    max={900}
                                    step={100}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ headingFontWeightMobile: val })}
                                    min={100}
                                    max={900}
                                    step={100}
                                />
                            ...
                            <BaseControl label={__('Line Height', 'twork-builder')}>
                                <RangeControl
                                    label={__('Desktop', 'twork-builder')}
                                ...
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ headingLineHeightTablet: val })}
                                    min={0.8}
                                    max={2}
                                    step={0.1}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ headingLineHeightMobile: val })}
                                    min={0.8}
                                    max={2}
                                    step={0.1}
                                />
                            ...
                            <BaseControl label={__('Letter Spacing (em)', 'twork-builder')}>
                                <RangeControl
                                    label={__('Desktop', 'twork-builder')}
                                ...
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ headingLetterSpacingTablet: val })}
                                    min={-0.05}
                                    max={0.05}
                                    step={0.01}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ headingLetterSpacingMobile: val })}
                                    min={-0.05}
                                    max={0.05}
                                    step={0.01}
                                />
                            ...
                            <BaseControl label={__('Margin (px)', 'twork-builder')}>
                                ...
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ headingMarginTop: val })}
                                    min={0}
                                    max={100}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ headingMarginRight: val })}
                                    min={0}
                                    max={100}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ headingMarginBottom: val })}
                                    min={0}
                                    max={100}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ headingMarginLeft: val })}
                                    min={0}
                                    max={100}
                                    step={5}
                                />
                                ...
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ headingMarginTopTablet: val })}
                                    min={0}
                                    max={80}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ headingMarginRightTablet: val })}
                                    min={0}
                                    max={80}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ headingMarginBottomTablet: val })}
                                    min={0}
                                    max={80}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ headingMarginLeftTablet: val })}
                                    min={0}
                                    max={80}
                                    step={5}
                                />
                                ...
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ headingMarginTopMobile: val })}
                                    min={0}
                                    max={60}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ headingMarginRightMobile: val })}
                                    min={0}
                                    max={60}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ headingMarginBottomMobile: val })}
                                    min={0}
                                    max={60}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ headingMarginLeftMobile: val })}
                                    min={0}
                                    max={60}
                                    step={5}
                                />
                            ...
                            <BaseControl label={__('Padding (px)', 'twork-builder')}>
                                ...
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ headingPaddingTop: val })}
                                    min={0}
                                    max={50}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ headingPaddingRight: val })}
                                    min={0}
                                    max={50}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ headingPaddingBottom: val })}
                                    min={0}
                                    max={50}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ headingPaddingLeft: val })}
                                    min={0}
                                    max={50}
                                    step={5}
                                />
                                ...
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ headingPaddingTopTablet: val })}
                                    min={0}
                                    max={40}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ headingPaddingRightTablet: val })}
                                    min={0}
                                    max={40}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ headingPaddingBottomTablet: val })}
                                    min={0}
                                    max={40}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ headingPaddingLeftTablet: val })}
                                    min={0}
                                    max={40}
                                    step={5}
                                />
                                ...
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ headingPaddingTopMobile: val })}
                                    min={0}
                                    max={30}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ headingPaddingRightMobile: val })}
                                    min={0}
                                    max={30}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ headingPaddingBottomMobile: val })}
                                    min={0}
                                    max={30}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ headingPaddingLeftMobile: val })}
                                    min={0}
                                    max={30}
                                    step={5}
                                />
                            ...
                            <BaseControl label={__('Text Alignment', 'twork-builder')}>
                                ...
                                <SelectControl
                                    label={__('Tablet', 'twork-builder')}
                                    value={headingAlignmentTablet || headingAlignment}
                                    options={[
                                        { label: __('Use Desktop', 'twork-builder'), value: '' },
                                        { label: __('Inherit from Content', 'twork-builder'), value: 'inherit' },
                                        { label: __('Left', 'twork-builder'), value: 'left' },
                                    ...
                                    onChange={(val) => setAttributes({ headingAlignmentTablet: val || '' })}
                                />
                                <SelectControl
                                    label={__('Mobile', 'twork-builder')}
                                    value={headingAlignmentMobile || headingAlignment}
                                    options={[
                                        { label: __('Use Desktop', 'twork-builder'), value: '' },
                                        { label: __('Inherit from Content', 'twork-builder'), value: 'inherit' },
                                        { label: __('Left', 'twork-builder'), value: 'left' },
                                    ...
                                    onChange={(val) => setAttributes({ headingAlignmentMobile: val || '' })}
                                />
                            </BaseControl>
                            ...
                            <ToggleControl
                                label={__('Show Highlight', 'twork-builder')}
                                checked={showHighlight}
                                onChange={(val) => setAttributes({ showHighlight: val })}
                            />
                            ...
                            {showHighlight && (
                                <>
                                    <TextControl
                                        ...
                                        help={__('Text to highlight in the heading', 'twork-builder')}
                                    />
                                    ...
                                    <RangeControl
                                        label={__('Highlight Font Weight', 'twork-builder')}
                                        value={highlightFontWeight}
                                        onChange={(val) => setAttributes({ highlightFontWeight: val })}
                                        min={100}
                                        max={900}
                                        step={100}
                                    />
                                    ...
                                    <RangeControl
                                        label={__('Highlight Font Size (em)', 'twork-builder')}
                                        value={highlightFontSize}
                                        onChange={(val) => setAttributes({ highlightFontSize: val })}
                                        min={0.8}
                                        max={2}
                                        step={0.1}
                                    />
                                    ...
                                    <BaseControl
                                        label={__('Responsive Settings', 'twork-builder')}
                                        help={__('Customize highlight text for different screen sizes', 'twork-builder')}
                                    >
                                        <h4 style={{ margin: '10px 0 5px 0', fontSize: '13px', fontWeight: 600 }}>
                                            {__('Tablet (992px and below)', 'twork-builder')}
                                        </h4>
                                        <PanelColorSettings
                                            title={__('Highlight Color (Tablet)', 'twork-builder')}
                                            colorSettings={[
                                                {
                                                    value: highlightColorTablet || highlightColor,
                                                    onChange: (val) => setAttributes({ highlightColorTablet: val || '' }),
                                                    label: __('Color', 'twork-builder')
                                                }
                                            ]}
                                        />
                                        <RangeControl
                                            label={__('Font Weight (Tablet)', 'twork-builder')}
                                            value={highlightFontWeightTablet}
                                            onChange={(val) => setAttributes({ highlightFontWeightTablet: val })}
                                            min={100}
                                            max={900}
                                            step={100}
                                        />
                                        <RangeControl
                                            label={__('Font Size (em) - Tablet', 'twork-builder')}
                                            value={highlightFontSizeTablet}
                                            onChange={(val) => setAttributes({ highlightFontSizeTablet: val })}
                                            min={0.8}
                                            max={2}
                                            step={0.1}
                                        />
                                        ...
                                        <h4 style={{ margin: '10px 0 5px 0', fontSize: '13px', fontWeight: 600 }}>
                                            {__('Mobile (768px and below)', 'twork-builder')}
                                        </h4>
                                        <PanelColorSettings
                                            title={__('Highlight Color (Mobile)', 'twork-builder')}
                                            colorSettings={[
                                                {
                                                    value: highlightColorMobile || highlightColor,
                                                    onChange: (val) => setAttributes({ highlightColorMobile: val || '' }),
                                                    label: __('Color', 'twork-builder')
                                                }
                                            ]}
                                        />
                                        <RangeControl
                                            label={__('Font Weight (Mobile)', 'twork-builder')}
                                            value={highlightFontWeightMobile}
                                            onChange={(val) => setAttributes({ highlightFontWeightMobile: val })}
                                            min={100}
                                            max={900}
                                            step={100}
                                        />
                                        <RangeControl
                                            label={__('Font Size (em) - Mobile', 'twork-builder')}
                                            value={highlightFontSizeMobile}
                                            onChange={(val) => setAttributes({ highlightFontSizeMobile: val })}
                                            min={0.8}
                                            max={2}
                                            step={0.1}
                                        />
                    ...
                    {showDescription && (
                        <>
                            <RichText
                                ...
                                placeholder={__('Description text...', 'twork-builder')}
                            />
                            ...
                            <BaseControl label={__('Text Color', 'twork-builder')}>
                                ...
                                <PanelColorSettings
                                    ...
                                    colorSettings={[
                                        {
                                            value: descriptionColorTablet || descriptionColor,
                                            onChange: (val) => setAttributes({ descriptionColorTablet: val || '' }),
                                            label: __('Color (Tablet)', 'twork-builder')
                                        }
                                    ]}
                                />
                                <PanelColorSettings
                                    ...
                                    colorSettings={[
                                        {
                                            value: descriptionColorMobile || descriptionColor,
                                            onChange: (val) => setAttributes({ descriptionColorMobile: val || '' }),
                                            label: __('Color (Mobile)', 'twork-builder')
                                        }
                                    ]}
                                />
                            ...
                            <BaseControl label={__('Font Size', 'twork-builder')}>
                                ...
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ descriptionFontSizeTablet: val })}
                                    min={0.8}
                                    max={1.8}
                                    step={0.05}
                                />
                            ...
                            <BaseControl label={__('Line Height', 'twork-builder')}>
                                ...
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ descriptionLineHeightTablet: val })}
                                    min={1}
                                    max={2.5}
                                    step={0.1}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ descriptionLineHeightMobile: val })}
                                    min={1}
                                    max={2.5}
                                    step={0.1}
                                />
                            ...
                            <BaseControl label={__('Margin (px)', 'twork-builder')}>
                                ...
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ descriptionMarginTop: val })}
                                    min={0}
                                    max={100}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ descriptionMarginRight: val })}
                                    min={0}
                                    max={100}
                                    step={5}
                                />
                                ...
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ descriptionMarginLeft: val })}
                                    min={0}
                                    max={100}
                                    step={5}
                                />
                                ...
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ descriptionMarginTopTablet: val })}
                                    min={0}
                                    max={80}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ descriptionMarginRightTablet: val })}
                                    min={0}
                                    max={80}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ descriptionMarginBottomTablet: val })}
                                    min={0}
                                    max={80}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ descriptionMarginLeftTablet: val })}
                                    min={0}
                                    max={80}
                                    step={5}
                                />
                                ...
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ descriptionMarginTopMobile: val })}
                                    min={0}
                                    max={60}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ descriptionMarginRightMobile: val })}
                                    min={0}
                                    max={60}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ descriptionMarginBottomMobile: val })}
                                    min={0}
                                    max={60}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ descriptionMarginLeftMobile: val })}
                                    min={0}
                                    max={60}
                                    step={5}
                                />
                            ...
                            <BaseControl label={__('Padding (px)', 'twork-builder')}>
                                ...
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ descriptionPaddingTop: val })}
                                    min={0}
                                    max={50}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ descriptionPaddingRight: val })}
                                    min={0}
                                    max={50}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ descriptionPaddingBottom: val })}
                                    min={0}
                                    max={50}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ descriptionPaddingLeft: val })}
                                    min={0}
                                    max={50}
                                    step={5}
                                />
                                ...
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ descriptionPaddingTopTablet: val })}
                                    min={0}
                                    max={40}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ descriptionPaddingRightTablet: val })}
                                    min={0}
                                    max={40}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ descriptionPaddingBottomTablet: val })}
                                    min={0}
                                    max={40}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ descriptionPaddingLeftTablet: val })}
                                    min={0}
                                    max={40}
                                    step={5}
                                />
                                ...
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ descriptionPaddingTopMobile: val })}
                                    min={0}
                                    max={30}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ descriptionPaddingRightMobile: val })}
                                    min={0}
                                    max={30}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ descriptionPaddingBottomMobile: val })}
                                    min={0}
                                    max={30}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ descriptionPaddingLeftMobile: val })}
                                    min={0}
                                    max={30}
                                    step={5}
                                />
                            ...
                            <BaseControl label={__('Text Alignment', 'twork-builder')}>
                                <SelectControl
                                    ...
                                    onChange={(val) => setAttributes({ descriptionAlignment: val || '' })}
                                />
                                <SelectControl
                                    label={__('Tablet', 'twork-builder')}
                                    value={descriptionAlignmentTablet || descriptionAlignment}
                                    options={[
                                        { label: __('Use Desktop', 'twork-builder'), value: '' },
                                        { label: __('Inherit from Content', 'twork-builder'), value: 'inherit' },
                                        { label: __('Left', 'twork-builder'), value: 'left' },
                                    ...
                                    onChange={(val) => setAttributes({ descriptionAlignmentTablet: val || '' })}
                                />
                                <SelectControl
                                    label={__('Mobile', 'twork-builder')}
                                    value={descriptionAlignmentMobile || descriptionAlignment}
                                    options={[
                                        { label: __('Use Desktop', 'twork-builder'), value: '' },
                                        { label: __('Inherit from Content', 'twork-builder'), value: 'inherit' },
                                        { label: __('Left', 'twork-builder'), value: 'left' },
                                    ...
                                    onChange={(val) => setAttributes({ descriptionAlignmentMobile: val || '' })}
                                />
                            </BaseControl>
                        </>
                    )}
                ...
                >
                    <ToggleControl
                        ...
                        onChange={(val) => setAttributes({ showNewsletterForm: val })}
                    />
                        ...
                        <>
                            <BaseControl label={__('Margin (px)', 'twork-builder')}>
                                ...
                                <RangeControl
                                    label={__('Top', 'twork-builder')}
                                    value={formMarginTop}
                                    onChange={(val) => setAttributes({ formMarginTop: val })}
                                    min={0}
                                    max={100}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ formMarginRight: val })}
                                    min={0}
                                    max={100}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ formMarginBottom: val })}
                                    min={0}
                                    max={100}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ formMarginLeft: val })}
                                    min={0}
                                    max={100}
                                    step={5}
                                />
                                ...
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ formMarginTopTablet: val })}
                                    min={0}
                                    max={80}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ formMarginRightTablet: val })}
                                    min={0}
                                    max={80}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ formMarginBottomTablet: val })}
                                    min={0}
                                    max={80}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ formMarginLeftTablet: val })}
                                    min={0}
                                    max={80}
                                    step={5}
                                />
                                ...
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ formMarginTopMobile: val })}
                                    min={0}
                                    max={60}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ formMarginRightMobile: val })}
                                    min={0}
                                    max={60}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ formMarginBottomMobile: val })}
                                    min={0}
                                    max={60}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ formMarginLeftMobile: val })}
                                    min={0}
                                    max={60}
                                    step={5}
                                />
                            ...
                            <BaseControl label={__('Padding (px)', 'twork-builder')}>
                                ...
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ formPaddingTop: val })}
                                    min={0}
                                    max={50}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ formPaddingRight: val })}
                                    min={0}
                                    max={50}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ formPaddingBottom: val })}
                                    min={0}
                                    max={50}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ formPaddingLeft: val })}
                                    min={0}
                                    max={50}
                                    step={5}
                                />
                                ...
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ formPaddingTopTablet: val })}
                                    min={0}
                                    max={40}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ formPaddingRightTablet: val })}
                                    min={0}
                                    max={40}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ formPaddingBottomTablet: val })}
                                    min={0}
                                    max={40}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ formPaddingLeftTablet: val })}
                                    min={0}
                                    max={40}
                                    step={5}
                                />
                                ...
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ formPaddingTopMobile: val })}
                                    min={0}
                                    max={30}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ formPaddingRightMobile: val })}
                                    min={0}
                                    max={30}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ formPaddingBottomMobile: val })}
                                    min={0}
                                    max={30}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ formPaddingLeftMobile: val })}
                                    min={0}
                                    max={30}
                                    step={5}
                                />
                            ...
                            <BaseControl label={__('Form Max Width (px)', 'twork-builder')}>
                                <RangeControl
                                    label={__('Desktop', 'twork-builder')}
                                    value={formMaxWidth}
                                    onChange={(val) => setAttributes({ formMaxWidth: val })}
                                    min={300}
                                    max={800}
                                    step={10}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ formMaxWidthTablet: val })}
                                    min={300}
                                    max={800}
                                    step={10}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ formMaxWidthMobile: val })}
                                    min={250}
                                    max={600}
                                    step={10}
                                />
                            ...
                            <BaseControl label={__('Form Border Radius (px)', 'twork-builder')}>
                                <RangeControl
                                    label={__('Desktop', 'twork-builder')}
                                    value={formBorderRadius}
                                    onChange={(val) => setAttributes({ formBorderRadius: val })}
                                    min={0}
                                    max={100}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ formBorderRadiusTablet: val })}
                                    min={0}
                                    max={100}
                                    step={5}
                                />
                                <RangeControl
                                    ...
                                    onChange={(val) => setAttributes({ formBorderRadiusMobile: val })}
                                    min={0}
                                    max={100}
                                    step={5}
                                />
                            ...
                            <BaseControl label={__('Form Alignment', 'twork-builder')}>
                                <SelectControl
                                    label={__('Desktop', 'twork-builder')}
                                    value={formAlignment}
                                    options={[
                                    ...
                                    onChange={(val) => setAttributes({ formAlignment: val || '' })}
                                />
                                <SelectControl
                                    label={__('Tablet', 'twork-builder')}
                                    value={formAlignmentTablet || formAlignment}
                                    options={[
                                        { label: __('Use Desktop', 'twork-builder'), value: '' },
                                        { label: __('Inherit from Content', 'twork-builder'), value: 'inherit' },
                                        { label: __('Left', 'twork-builder'), value: 'left' },
                                    ...
                                    onChange={(val) => setAttributes({ formAlignmentTablet: val || '' })}
                                />
                                <SelectControl
                                    label={__('Mobile', 'twork-builder')}
                                    value={formAlignmentMobile || formAlignment}
                                    options={[
                                        { label: __('Use Desktop', 'twork-builder'), value: '' },
                                        { label: __('Inherit from Content', 'twork-builder'), value: 'inherit' },
                                        { label: __('Left', 'twork-builder'), value: 'left' },
                                    ...
                                    onChange={(val) => setAttributes({ formAlignmentMobile: val || '' })}
                                />
                            </BaseControl>
                            ...
                            <ToggleControl
                                ...
                                onChange={(val) => setAttributes({ formBoxShadow: val })}
                            />
                            ...
                            {formBoxShadow && (
                                <>
                                        ...
                                        colorSettings={[
                                            {
                                                ...
                                                onChange: (val) => setAttributes({ formBoxShadowColor: val }),
                                    ...
                                    <RangeControl
                                        ...
                                        onChange={(val) => setAttributes({ formBoxShadowBlur: val })}
                                        min={0}
                                        max={50}
                                        step={1}
                                    />
                                    ...
                                    <RangeControl
                                        ...
                                        onChange={(val) => setAttributes({ formBoxShadowSpread: val })}
                                        min={-20}
                                        max={20}
                                        step={1}
                                    />
                                    ...
                                    <RangeControl
                                        ...
                                        onChange={(val) => setAttributes({ formBoxShadowOffsetX: val })}
                                        min={-20}
                                        max={20}
                                        step={1}
                                    />
                                    ...
                                    <RangeControl
                                        ...
                                        onChange={(val) => setAttributes({ formBoxShadowOffsetY: val })}
                                        min={-20}
                                        max={20}
                                        step={1}
                                    />
                                    ...
                                    <PanelColorSettings
                                        title={__('Focus Shadow Color', 'twork-builder')}
                                        colorSettings={[
                                            {
                                                value: formFocusShadowColor,
                                                onChange: (val) => setAttributes({ formFocusShadowColor: val }),
                                                label: __('Focus Shadow Color', 'twork-builder')
                                            }
                                        ]}
                                    />

                                    <RangeControl
                                        label={__('Focus Shadow Blur (px)', 'twork-builder')}
                                        value={formFocusShadowBlur}
                                        onChange={(val) => setAttributes({ formFocusShadowBlur: val })}
                                        min={0}
                                        max={50}
                                        step={1}
                                    />
                ...
                >
                    ...
                    <BaseControl label={__('Email Input Colors', 'twork-builder')}>
                        <h4 style={{ margin: '10px 0 5px 0', fontSize: '13px', fontWeight: 600 }}>
                            {__('Desktop', 'twork-builder')}
                        </h4>
                        <PanelColorSettings
                            title={__('Desktop Colors', 'twork-builder')}
                            colorSettings={[
                                {
                                    value: emailBgColor,
                                    onChange: (val) => setAttributes({ emailBgColor: val }),
                                    label: __('Background Color', 'twork-builder')
                                },
                                {
                                    value: emailTextColor,
                                    onChange: (val) => setAttributes({ emailTextColor: val }),
                                    label: __('Text Color', 'twork-builder')
                                },
                                {
                                    value: emailPlaceholderColor,
                                    onChange: (val) => setAttributes({ emailPlaceholderColor: val }),
                                    label: __('Placeholder Color', 'twork-builder')
                                },
                                {
                                    value: emailBorderColor,
                                    onChange: (val) => setAttributes({ emailBorderColor: val }),
                                    label: __('Border Color', 'twork-builder')
                                },
                                {
                                    value: emailFocusBgColor,
                                    onChange: (val) => setAttributes({ emailFocusBgColor: val }),
                                    label: __('Focus Background', 'twork-builder')
                                },
                                {
                                    value: emailFocusBorderColor,
                                    onChange: (val) => setAttributes({ emailFocusBorderColor: val }),
                                    label: __('Focus Border Color', 'twork-builder')
                                }
                            ]}
                        />
                        ...
                        <PanelColorSettings
                            ...
                            colorSettings={[
                                {
                                    value: emailBgColorTablet || emailBgColor,
                                    onChange: (val) => setAttributes({ emailBgColorTablet: val || '' }),
                                    label: __('Background Color', 'twork-builder')
                                },
                                {
                                    value: emailTextColorTablet || emailTextColor,
                                    onChange: (val) => setAttributes({ emailTextColorTablet: val || '' }),
                                    label: __('Text Color', 'twork-builder')
                                },
                                {
                                    value: emailPlaceholderColorTablet || emailPlaceholderColor,
                                    onChange: (val) => setAttributes({ emailPlaceholderColorTablet: val || '' }),
                                    label: __('Placeholder Color', 'twork-builder')
                                },
                                {
                                    value: emailBorderColorTablet || emailBorderColor,
                                    onChange: (val) => setAttributes({ emailBorderColorTablet: val || '' }),
                                    label: __('Border Color', 'twork-builder')
                                },
                                {
                                    value: emailFocusBgColorTablet || emailFocusBgColor,
                                    onChange: (val) => setAttributes({ emailFocusBgColorTablet: val || '' }),
                                    label: __('Focus Background', 'twork-builder')
                                },
                                {
                                    value: emailFocusBorderColorTablet || emailFocusBorderColor,
                                    onChange: (val) => setAttributes({ emailFocusBorderColorTablet: val || '' }),
                                    label: __('Focus Border Color', 'twork-builder')
                                }
                            ]}
                        />
                        ...
                        <PanelColorSettings
                            ...
                            colorSettings={[
                                {
                                    value: emailBgColorMobile || emailBgColor,
                                    onChange: (val) => setAttributes({ emailBgColorMobile: val || '' }),
                                    label: __('Background Color', 'twork-builder')
                                },
                                {
                                    value: emailTextColorMobile || emailTextColor,
                                    onChange: (val) => setAttributes({ emailTextColorMobile: val || '' }),
                                    label: __('Text Color', 'twork-builder')
                                },
                                {
                                    value: emailPlaceholderColorMobile || emailPlaceholderColor,
                                    onChange: (val) => setAttributes({ emailPlaceholderColorMobile: val || '' }),
                                    label: __('Placeholder Color', 'twork-builder')
                                },
                                {
                                    value: emailBorderColorMobile || emailBorderColor,
                                    onChange: (val) => setAttributes({ emailBorderColorMobile: val || '' }),
                                    label: __('Border Color', 'twork-builder')
                                },
                                {
                                    value: emailFocusBgColorMobile || emailFocusBgColor,
                                    onChange: (val) => setAttributes({ emailFocusBgColorMobile: val || '' }),
                                    label: __('Focus Background', 'twork-builder')
                                },
                                {
                                    value: emailFocusBorderColorMobile || emailFocusBorderColor,
                                    onChange: (val) => setAttributes({ emailFocusBorderColorMobile: val || '' }),
                                    label: __('Focus Border Color', 'twork-builder')
                                }
                            ]}
                        />
                    ...
                    <BaseControl label={__('Font Size', 'twork-builder')}>
                        <RangeControl
                            label={__('Desktop (rem)', 'twork-builder')}
                            value={emailFontSize}
                            onChange={(val) => setAttributes({ emailFontSize: val })}
                            min={0.7}
                            max={1.5}
                            step={0.05}
                        />
                        <RangeControl
                            ...
                            onChange={(val) => setAttributes({ emailFontSizeTablet: val })}
                            min={0.7}
                            max={1.3}
                            step={0.05}
                        />
                        <RangeControl
                            ...
                            onChange={(val) => setAttributes({ emailFontSizeMobile: val })}
                            min={0.7}
                            max={1.2}
                            step={0.05}
                        />
                    ...
                    <BaseControl label={__('Padding Vertical', 'twork-builder')}>
                        <RangeControl
                            label={__('Desktop (px)', 'twork-builder')}
                            value={emailPaddingVertical}
                            onChange={(val) => setAttributes({ emailPaddingVertical: val })}
                            min={8}
                            max={30}
                            step={1}
                        />
                        <RangeControl
                            ...
                            onChange={(val) => setAttributes({ emailPaddingVerticalTablet: val })}
                            min={8}
                            max={28}
                            step={1}
                        />
                        <RangeControl
                            ...
                            onChange={(val) => setAttributes({ emailPaddingVerticalMobile: val })}
                            min={8}
                            max={25}
                            step={1}
                        />
                    ...
                    <BaseControl label={__('Padding Horizontal', 'twork-builder')}>
                        <RangeControl
                            label={__('Desktop (px)', 'twork-builder')}
                            value={emailPaddingHorizontal}
                            onChange={(val) => setAttributes({ emailPaddingHorizontal: val })}
                            min={12}
                            max={40}
                            step={1}
                        />
                        <RangeControl
                            ...
                            onChange={(val) => setAttributes({ emailPaddingHorizontalTablet: val })}
                            min={12}
                            max={35}
                            step={1}
                        />
                        <RangeControl
                            ...
                            onChange={(val) => setAttributes({ emailPaddingHorizontalMobile: val })}
                            min={12}
                            max={30}
                            step={1}
                        />
                ...
                >
                    ...
                    <BaseControl label={__('Button Colors', 'twork-builder')}>
                        <h4 style={{ margin: '10px 0 5px 0', fontSize: '13px', fontWeight: 600 }}>
                            {__('Desktop', 'twork-builder')}
                        </h4>
                        <PanelColorSettings
                        ...
                        <PanelColorSettings
                            ...
                            colorSettings={[
                                {
                                    value: buttonBgColorTablet || buttonBgColor,
                                    onChange: (val) => setAttributes({ buttonBgColorTablet: val || '' }),
                                    label: __('Background Color', 'twork-builder')
                                },
                                {
                                    value: buttonHoverBgColorTablet || buttonHoverBgColor,
                                    onChange: (val) => setAttributes({ buttonHoverBgColorTablet: val || '' }),
                                    label: __('Hover Background Color', 'twork-builder')
                                },
                                {
                                    value: buttonTextColorTablet || buttonTextColor,
                                    onChange: (val) => setAttributes({ buttonTextColorTablet: val || '' }),
                                    label: __('Text Color', 'twork-builder')
                                }
                            ]}
                        />
                        ...
                        <PanelColorSettings
                            ...
                            colorSettings={[
                                {
                                    value: buttonBgColorMobile || buttonBgColor,
                                    onChange: (val) => setAttributes({ buttonBgColorMobile: val || '' }),
                                    label: __('Background Color', 'twork-builder')
                                },
                                {
                                    value: buttonHoverBgColorMobile || buttonHoverBgColor,
                                    onChange: (val) => setAttributes({ buttonHoverBgColorMobile: val || '' }),
                                    label: __('Hover Background Color', 'twork-builder')
                                },
                                {
                                    value: buttonTextColorMobile || buttonTextColor,
                                    onChange: (val) => setAttributes({ buttonTextColorMobile: val || '' }),
                                    label: __('Text Color', 'twork-builder')
                                }
                            ]}
                        />
                    ...
                    <BaseControl label={__('Font Size', 'twork-builder')}>
                        ...
                        <RangeControl
                            ...
                            onChange={(val) => setAttributes({ buttonFontSizeTablet: val })}
                            min={0.7}
                            max={1.3}
                            step={0.05}
                        />
                    ...
                    <BaseControl label={__('Font Weight', 'twork-builder')}>
                        ...
                        <RangeControl
                            ...
                            onChange={(val) => setAttributes({ buttonFontWeightTablet: val })}
                            min={100}
                            max={900}
                            step={100}
                        />
                        <RangeControl
                            ...
                            onChange={(val) => setAttributes({ buttonFontWeightMobile: val })}
                            min={100}
                            max={900}
                            step={100}
                        />
                    ...
                    <BaseControl label={__('Text Transform', 'twork-builder')}>
                        ...
                        <SelectControl
                            label={__('Tablet', 'twork-builder')}
                            value={buttonTextTransformTablet || buttonTextTransform}
                            options={[
                                { label: __('Use Desktop', 'twork-builder'), value: '' },
                                { label: __('None', 'twork-builder'), value: 'none' },
                                { label: __('Uppercase', 'twork-builder'), value: 'uppercase' },
                            ...
                            onChange={(val) => setAttributes({ buttonTextTransformTablet: val || '' })}
                        />
                        <SelectControl
                            label={__('Mobile', 'twork-builder')}
                            value={buttonTextTransformMobile || buttonTextTransform}
                            options={[
                                { label: __('Use Desktop', 'twork-builder'), value: '' },
                                { label: __('None', 'twork-builder'), value: 'none' },
                                { label: __('Uppercase', 'twork-builder'), value: 'uppercase' },
                            ...
                            onChange={(val) => setAttributes({ buttonTextTransformMobile: val || '' })}
                        />
                    </BaseControl>
                    ...
                    <BaseControl label={__('Letter Spacing (px)', 'twork-builder')}>
                        ...
                        <RangeControl
                            ...
                            onChange={(val) => setAttributes({ buttonLetterSpacingTablet: val })}
                            min={0}
                            max={2}
                            step={0.1}
                        />
                        <RangeControl
                            ...
                            onChange={(val) => setAttributes({ buttonLetterSpacingMobile: val })}
                            min={0}
                            max={2}
                            step={0.1}
                        />
                    ...
                    <BaseControl label={__('Padding Vertical', 'twork-builder')}>
                        ...
                        <RangeControl
                            ...
                            onChange={(val) => setAttributes({ buttonPaddingVerticalTablet: val })}
                            min={8}
                            max={28}
                            step={1}
                        />
                    ...
                    <BaseControl label={__('Padding Horizontal', 'twork-builder')}>
                        ...
                        <RangeControl
                            ...
                            onChange={(val) => setAttributes({ buttonPaddingHorizontalTablet: val })}
                            min={12}
                            max={50}
                            step={2}
                        />
                    ...
                    {buttonBoxShadow && (
                        <>
                            ...
                            <RangeControl
                                ...
                                onChange={(val) => setAttributes({ buttonHoverShadowBlur: val })}
                                min={0}
                                max={30}
                                step={1}
                            />
                            ...
                            <RangeControl
                                ...
                                onChange={(val) => setAttributes({ buttonHoverShadowOffsetY: val })}
                                min={-10}
                                max={10}
                                step={1}
                            />
                            ...
                            <RangeControl
                                ...
                                max={5}
                                step={1}
                                help={__('Negative = up, Positive = down', 'twork-builder')}
                            />
                        </>
                    )}
                </PanelBody>
            ...
            <div {...blockProps}>
                ...
                <div className="good-news-grid" style={gridStyle}>
                    <div className="good-news-content-wrapper" style={contentWrapperStyle}>
                            ...
                            {showMetaTitle && (
                                <p
                                    ...
                                    style={{
                                        ...
                                        '--meta-font-weight': metaTitleFontWeight,
                                        '--meta-color': metaTitleColor,
                                        '--meta-text-transform': metaTitleTextTransform,
                                        ...
                                        '--meta-font-weight-tablet': metaTitleFontWeightTablet,
                                        '--meta-font-weight-mobile': metaTitleFontWeightMobile,
                                        '--meta-color-tablet': metaTitleColorTablet || metaTitleColor,
                                        '--meta-color-mobile': metaTitleColorMobile || metaTitleColor,
                                        '--meta-text-transform-tablet': metaTitleTextTransformTablet || metaTitleTextTransform,
                                        '--meta-text-transform-mobile': metaTitleTextTransformMobile || metaTitleTextTransform,
                                        ...
                                        '--meta-alignment': metaTitleAlignment || contentAlignment,
                                        '--meta-alignment-tablet': metaTitleAlignmentTablet || metaTitleAlignment || contentAlignmentTablet || contentAlignment,
                                        '--meta-alignment-mobile': metaTitleAlignmentMobile || metaTitleAlignment || contentAlignmentMobile || contentAlignment
                                    }}
                                >
                                    {metaTitle}
                                </p>
                            ...
                            {showHeading && (
                                <h2
                                    ...
                                    style={{
                                        ...
                                        '--heading-alignment': headingAlignment || contentAlignment,
                                        '--heading-font-size-tablet': `${headingFontSizeTablet}rem`,
                                        '--heading-font-size-mobile': `${headingFontSizeMobile}rem`,
                                        '--heading-font-weight-tablet': headingFontWeightTablet,
                                        '--heading-font-weight-mobile': headingFontWeightMobile,
                                        '--heading-color-tablet': headingColorTablet || headingColor,
                                        '--heading-color-mobile': headingColorMobile || headingColor,
                                        '--heading-line-height-tablet': headingLineHeightTablet,
                                        '--heading-line-height-mobile': headingLineHeightMobile,
                                        ...
                                        '--heading-alignment': headingAlignment || contentAlignment,
                                        '--heading-alignment-tablet': headingAlignmentTablet || headingAlignment || contentAlignmentTablet || contentAlignment,
                                        '--heading-alignment-mobile': headingAlignmentMobile || headingAlignment || contentAlignmentMobile || contentAlignment,
                                        '--highlight-color': highlightColor,
                                        '--highlight-color-tablet': highlightColorTablet || highlightColor,
                                        '--highlight-color-mobile': highlightColorMobile || highlightColor,
                                        '--highlight-font-weight': highlightFontWeight,
                                        '--highlight-font-weight-tablet': highlightFontWeightTablet,
                                        '--highlight-font-weight-mobile': highlightFontWeightMobile,
                            ...
                            {showDescription && (
                                <RichText
                                    ...
                                    style={{
                                        ...
                                        '--description-line-height': descriptionLineHeight,
                                        ...
                                        '--description-alignment': descriptionAlignment || contentAlignment,
                                        '--description-font-size-tablet': `${descriptionFontSizeTablet}rem`,
                                        '--description-font-size-mobile': `${descriptionFontSizeMobile}rem`,
                                        '--description-color-tablet': descriptionColorTablet || descriptionColor,
                                        '--description-color-mobile': descriptionColorMobile || descriptionColor,
                                        '--description-line-height-tablet': descriptionLineHeightTablet,
                                        '--description-line-height-mobile': descriptionLineHeightMobile,
                                        ...
                                        '--description-alignment-tablet': descriptionAlignmentTablet || descriptionAlignment || contentAlignmentTablet || contentAlignment,
                                        '--description-alignment-mobile': descriptionAlignmentMobile || descriptionAlignment || contentAlignmentMobile || contentAlignment
                                    }}
                                />
                            )}
                            ...
                            {showNewsletterForm && (
                                <form
                                    ...
                                    style={{
                                        ...
                                        width: '100%',
                                        textAlign: formAlignment || contentAlignment,
                                        ...
                                        '--form-alignment': formAlignment || contentAlignment,
                                        '--form-alignment-tablet': formAlignmentTablet || formAlignment || contentAlignmentTablet || contentAlignment,
                                        '--form-alignment-mobile': formAlignmentMobile || formAlignment || contentAlignmentMobile || contentAlignment
                                    }}
                                    onSubmit={(e) => e.preventDefault()}
                                >
                                    <div className="form-group" style={formGroupStyle}>
                                        <label htmlFor="newsletter-email-editor" className="visually-hidden">
                                            {__('Email Address', 'twork-builder')}
                                        </label>
                                        <input
                    ...
                    <div className="good-news-image-bg" style={imageBgStyle}>
                        {!backgroundImage && (
                            <div style={{
                                ...
                                {__('Background Image Placeholder', 'twork-builder')}
                            </div>
                        )}
