            ...
            if (regex.test(line)) {
                ...
                matches.forEach((m) => {
                    ...
                    if (m.index > lastIndex) {
                        ...
                        highlightedLine += beforeText.replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;');
                    }
                    
                    // Add highlighted text with responsive CSS variables
                    // Escape the matched text for HTML
                    const escapedMatch = m.text.replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;');
                    highlightedLine += `<span class="highlight-red" style="font-weight: ${highlightFontWeight}; color: ${highlightColor}; font-size: ${highlightFontSize}em; display: block; line-height: 1; --highlight-font-weight-tablet: ${highlightFontWeightTablet}; --highlight-font-weight-mobile: ${highlightFontWeightMobile}; --highlight-font-size-tablet: ${highlightFontSizeTablet}em; --highlight-font-size-mobile: ${highlightFontSizeMobile}em; --highlight-color-tablet: ${highlightColorTablet || highlightColor}; --highlight-color-mobile: ${highlightColorMobile || highlightColor};">${escapedMatch}</span>`;
                ...
                if (lastIndex < line.length) {
                    ...
                    highlightedLine += afterText.replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;');
                }
        ...
        <section {...blockProps}>
            ...
            <div className="good-news-grid" style={gridStyle}>
                <div
                    ...
                    data-animation-type={animationOnScroll ? animationType : undefined}
                    data-animation-delay={animationOnScroll ? animationDelay : undefined}
                >
                    <div className="good-news-content" style={contentStyle}>
                        {showMetaTitle && (
                            <p
                                ...
                                style={{
                                    '--meta-font-size': `${metaTitleFontSize ?? 0.8}rem`,
                                    '--meta-font-weight': metaTitleFontWeight ?? 700,
                                    '--meta-color': metaTitleColor || '#212121',
                                    '--meta-text-transform': metaTitleTextTransform || 'uppercase',
                                    '--meta-letter-spacing': `${metaTitleLetterSpacing ?? 1.5}px`,
                                    '--meta-margin-top': `${metaTitleMarginTop ?? 0}px`,
                                    '--meta-margin-right': `${metaTitleMarginRight ?? 0}px`,
                                    '--meta-margin-bottom': `${metaTitleMarginBottom ?? 15}px`,
                                    '--meta-margin-left': `${metaTitleMarginLeft ?? 0}px`,
                                    '--meta-padding-top': `${metaTitlePaddingTop ?? 0}px`,
                                    '--meta-padding-right': `${metaTitlePaddingRight ?? 0}px`,
                                    '--meta-padding-bottom': `${metaTitlePaddingBottom ?? 0}px`,
                                    '--meta-padding-left': `${metaTitlePaddingLeft ?? 0}px`,
                                    '--meta-font-size-tablet': `${metaTitleFontSizeTablet ?? metaTitleFontSize ?? 0.75}rem`,
                                    '--meta-font-size-mobile': `${metaTitleFontSizeMobile ?? metaTitleFontSizeTablet ?? metaTitleFontSize ?? 0.7}rem`,
                                    '--meta-font-weight-tablet': metaTitleFontWeightTablet ?? metaTitleFontWeight ?? 700,
                                    '--meta-font-weight-mobile': metaTitleFontWeightMobile ?? metaTitleFontWeightTablet ?? metaTitleFontWeight ?? 700,
                                    '--meta-color-tablet': metaTitleColorTablet || metaTitleColor || '#212121',
                                    '--meta-color-mobile': metaTitleColorMobile || metaTitleColorTablet || metaTitleColor || '#212121',
                                    '--meta-text-transform-tablet': metaTitleTextTransformTablet || metaTitleTextTransform || 'uppercase',
                                    '--meta-text-transform-mobile': metaTitleTextTransformMobile || metaTitleTextTransformTablet || metaTitleTextTransform || 'uppercase',
                                    '--meta-letter-spacing-tablet': `${metaTitleLetterSpacingTablet ?? metaTitleLetterSpacing ?? 1.5}px`,
                                    '--meta-letter-spacing-mobile': `${metaTitleLetterSpacingMobile ?? metaTitleLetterSpacingTablet ?? metaTitleLetterSpacing ?? 1.5}px`,
                                    '--meta-margin-top-tablet': `${metaTitleMarginTopTablet ?? metaTitleMarginTop ?? 0}px`,
                                    '--meta-margin-right-tablet': `${metaTitleMarginRightTablet ?? metaTitleMarginRight ?? 0}px`,
                                    '--meta-margin-bottom-tablet': `${metaTitleMarginBottomTablet ?? metaTitleMarginBottom ?? 15}px`,
                                    '--meta-margin-left-tablet': `${metaTitleMarginLeftTablet ?? metaTitleMarginLeft ?? 0}px`,
                                    '--meta-margin-top-mobile': `${metaTitleMarginTopMobile ?? metaTitleMarginTopTablet ?? metaTitleMarginTop ?? 0}px`,
                                    '--meta-margin-right-mobile': `${metaTitleMarginRightMobile ?? metaTitleMarginRightTablet ?? metaTitleMarginRight ?? 0}px`,
                                    '--meta-margin-bottom-mobile': `${metaTitleMarginBottomMobile ?? metaTitleMarginBottomTablet ?? metaTitleMarginBottom ?? 15}px`,
                                    '--meta-margin-left-mobile': `${metaTitleMarginLeftMobile ?? metaTitleMarginLeftTablet ?? metaTitleMarginLeft ?? 0}px`,
                                    '--meta-padding-top-tablet': `${metaTitlePaddingTopTablet ?? metaTitlePaddingTop ?? 0}px`,
                                    '--meta-padding-right-tablet': `${metaTitlePaddingRightTablet ?? metaTitlePaddingRight ?? 0}px`,
                                    '--meta-padding-bottom-tablet': `${metaTitlePaddingBottomTablet ?? metaTitlePaddingBottom ?? 0}px`,
                                    '--meta-padding-left-tablet': `${metaTitlePaddingLeftTablet ?? metaTitlePaddingLeft ?? 0}px`,
                                    '--meta-padding-top-mobile': `${metaTitlePaddingTopMobile ?? metaTitlePaddingTopTablet ?? metaTitlePaddingTop ?? 0}px`,
                                    '--meta-padding-right-mobile': `${metaTitlePaddingRightMobile ?? metaTitlePaddingRightTablet ?? metaTitlePaddingRight ?? 0}px`,
                                    '--meta-padding-bottom-mobile': `${metaTitlePaddingBottomMobile ?? metaTitlePaddingBottomTablet ?? metaTitlePaddingBottom ?? 0}px`,
                                    '--meta-padding-left-mobile': `${metaTitlePaddingLeftMobile ?? metaTitlePaddingLeftTablet ?? metaTitlePaddingLeft ?? 0}px`,
                        ...
                        {showHeading && (
                            <h2
                                ...
                                dangerouslySetInnerHTML={{ __html: parseHeadingHTML(heading) }}
                            />
                        )}
