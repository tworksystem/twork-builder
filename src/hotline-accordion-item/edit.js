...
export default function Edit({ attributes, setAttributes }) {
    ...
    return (
        <>
            <InspectorControls>
                <PanelBody title={__('Hotline', 'twork-builder')} initialOpen={true}>
                    <TextControl
                        label={__('Label (e.g. Direct Line)', 'twork-builder')}
                        value={labelText}
                    ...
                    <TextControl
                        ...
                        help={__('e.g. fas fa-phone-alt', 'twork-builder')}
                    />
                </PanelBody>
            </InspectorControls>
            ...
            <div {...blockProps}>
                <div className="acc-head">
                    <RichText
                        ...
                        placeholder={__('Department name…', 'twork-builder')}
