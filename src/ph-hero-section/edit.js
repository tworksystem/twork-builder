      ...
      <InspectorControls>
        ...
        <PanelBody title={__('Content', 'twork-builder')} initialOpen={true}>
          <TextControl
            ...
            placeholder={__('Official Hospital Pharmacy', 'twork-builder')}
          />
          ...
          {showSearch && (
            <>
              ...
              />
              <TextControl
                label={__('Popular text', 'twork-builder')}
                help={__(
        ...
        >
          <TextControl
            ...
            value={pill1Text}
            onChange={(val) => setAttributes({ pill1Text: val })}
          />
          <TextControl
            label={__('Pill 1 icon class', 'twork-builder')}
            help={__('Font Awesome class, e.g. "fas fa-shipping-fast".', 'twork-builder')}
            value={pill1IconClass}
            onChange={(val) => setAttributes({ pill1IconClass: val })}
          />
          ...
          <TextControl
            ...
            value={pill2Text}
            onChange={(val) => setAttributes({ pill2Text: val })}
          />
          <TextControl
            label={__('Pill 2 icon class', 'twork-builder')}
            help={__('Font Awesome class, e.g. "fas fa-shield-alt".', 'twork-builder')}
            value={pill2IconClass}
            onChange={(val) => setAttributes({ pill2IconClass: val })}
          />
        </PanelBody>
      </InspectorControls>
          ...
          <div className="ph-hero-grid">
            <div className="ph-hero-text fade-up">
              ...
              <RichText
                ...
                placeholder={__('Authentic Medicine,\nDelivered to You.', 'twork-builder')}
              />
