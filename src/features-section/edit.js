...
const TEMPLATE = [
	[
		'twork/feature-card',
		{
			title: 'Advanced Tech',
			description:
				'4K Laparoscopy towers and modern modular operation theaters.',
	...
	[
		'twork/feature-card',
		{
			title: 'Expert Team',
			description:
				'Senior consultants with over 20 years of surgical experience.',
...
export default function Edit( { attributes, setAttributes, isSelected } ) {
	...
	const blockProps = useStableBlockProps(
		...
		[ containerClass, sectionId, undefined ]
	);
				...
				<InspectorControls>
					...
					>
						<TextControl
							...
							value={ sectionId }
							onChange={ ( v ) =>
								setAttributes( { sectionId: v || 'about' } )
							}
							help={ __(
