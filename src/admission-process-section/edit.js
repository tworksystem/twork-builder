...
export default function Edit( { attributes, setAttributes, isSelected } ) {
	...
	const TEMPLATE = [
		[
			'twork/admission-process-item',
			{
				stepNumber: 1,
				title: 'Registration',
				description: 'Visit the admission counter at the lobby.',
				listItems: [
					{ id: 1, text: 'Bring NRC / Passport' },
					{ id: 2, text: 'Insurance Card (if any)' },
					{ id: 3, text: "Doctor's Admission Note" },
					{ id: 4, text: 'Initial Deposit' },
				],
			},
		],
		...
		[
			'twork/admission-process-item',
			{
				stepNumber: 2,
				title: 'During Stay',
				description: 'Our team will guide you to your room.',
				listItems: [
					{ id: 1, text: '24/7 Nursing Care' },
					{ id: 2, text: 'Daily Doctor Rounds' },
					{ id: 3, text: 'Dietitian Consultation' },
					{ id: 4, text: 'Room Amenities Guide' },
				],
			},
		],
		...
		[
			'twork/admission-process-item',
			{
				stepNumber: 3,
				title: 'Discharge',
				description: 'Complete the process before leaving.',
				listItems: [
					{ id: 1, text: 'Final Bill Settlement' },
					{ id: 2, text: 'Collect Medical Reports' },
					{ id: 3, text: 'Take Home Medication' },
					{ id: 4, text: 'Follow-up Appointment' },
				],
			},
		],
	];
