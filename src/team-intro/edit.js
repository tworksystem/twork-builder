					...
					>
						...
						<BaseControl>
							<TextControl
								...
								onChange={ ( value ) =>
									setAttributes( { authorSignature: value } )
								}
				...
				<section className="team-intro">
					...
					<div className="team-intro__content" style={ contentStyle }>
						<div>
							...
							{ description && (
								<p
									className="team-intro__description"
									style={ { color: '#666' } }
								>
									{ description }
								</p>
