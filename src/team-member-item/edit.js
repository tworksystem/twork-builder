            ...
            <InspectorControls>
                ...
                >
                    {!memberImage ? (
                        <MediaPlaceholder
                            ...
                            allowedTypes={['image']}
                            multiple={false}
                            labels={{ title: __('Member Image', 'twork-builder') }}
                        />
                    ) : (
                        <div>
                            <img
                ...
                >
                        ...
                        colorSettings={[
                            {
                                ...
                                onChange: (val) => setAttributes({ memberNameColor: val }),
                    ...
                    <RangeControl
                        ...
                        onChange={(val) => setAttributes({ memberNameFontSize: val })}
                        min={1}
                        max={3}
                        step={0.1}
                    />
                    ...
                    <RangeControl
                        ...
                        onChange={(val) => setAttributes({ memberNameFontWeight: val })}
                        min={100}
                        max={900}
                        step={100}
                    />
                ...
                >
                        ...
                        colorSettings={[
                            {
                                ...
                                onChange: (val) => setAttributes({ memberPositionColor: val }),
                                label: __('Position Color', 'twork-builder')
                            }
                        ]}
                    />
                    ...
                    <RangeControl
                        ...
                        onChange={(val) => setAttributes({ memberPositionFontSize: val })}
                        min={0.8}
                        max={2}
                        step={0.1}
                    />
                    ...
                    <RangeControl
                        ...
                        onChange={(val) => setAttributes({ memberPositionFontWeight: val })}
                        min={100}
                        max={900}
                        step={100}
                    />
                    ...
                    <SelectControl
                        ...
                        onChange={(val) => setAttributes({ memberPositionTextTransform: val })}
                    />
                </PanelBody>
                ...
                >
                    <ToggleControl
                        ...
                        checked={showBio}
                        onChange={(val) => setAttributes({ showBio: val })}
                    />
                    ...
                    {showBio && (
                        <>
                                ...
                                colorSettings={[
                                    {
                                        ...
                                        onChange: (val) => setAttributes({ memberBioColor: val }),
                                        label: __('Bio Color', 'twork-builder')
                                    }
                                ]}
                            />
                            ...
                            <RangeControl
                                ...
                                onChange={(val) => setAttributes({ memberBioFontSize: val })}
                                min={0.8}
                                max={1.5}
                                step={0.05}
                            />
                            ...
                            <RangeControl
                                ...
                                onChange={(val) => setAttributes({ memberBioLineHeight: val })}
                                min={1}
                                max={2.5}
                                step={0.1}
                            />
                ...
                >
                    <ToggleControl
                        label={__('Show Specializations', 'twork-builder')}
                        checked={showSpecializations}
                        onChange={(val) => setAttributes({ showSpecializations: val })}
                    />

                    {showSpecializations && (
                        <>
                            <BaseControl label={__('Specialization Tags', 'twork-builder')}>
                                {specializations.map((spec) => (
                                    <div key={spec.id} style={{ marginBottom: '10px', display: 'flex', gap: '5px' }}>
                                        <TextControl
                                            value={spec.text}
                                            onChange={(val) => updateSpecialization(spec.id, val)}
                                            style={{ flex: 1 }}
                                        />
                                        <Button
                                            isDestructive
                                ...
                                >
                                    {__('Add Specialization', 'twork-builder')}
                                </Button>
                            </BaseControl>
                            ...
                            <PanelColorSettings
                                title={__('Specialization Colors', 'twork-builder')}
                                colorSettings={[
                                    {
                                        value: specializationBgColor,
                                        onChange: (val) => setAttributes({ specializationBgColor: val }),
                                        label: __('Background Color', 'twork-builder')
                                    },
                                    {
                                        value: specializationTextColor,
                                        onChange: (val) => setAttributes({ specializationTextColor: val }),
                            ...
                            <RangeControl
                                ...
                                onChange={(val) => setAttributes({ specializationFontSize: val })}
                                min={0.6}
                                max={1.2}
                                step={0.05}
                            />
                            ...
                            <RangeControl
                                ...
                                onChange={(val) => setAttributes({ specializationBorderRadius: val })}
                                min={0}
                                max={50}
                                step={1}
                            />
                ...
                >
                    <ToggleControl
                        ...
                        onChange={(val) => setAttributes({ showContactInfo: val })}
                    />
                    ...
                    {showContactInfo && (
                        <>
                            <TextControl
                                ...
                                value={memberEmail}
                                onChange={(val) => setAttributes({ memberEmail: val })}
                                type="email"
                            />
                            ...
                            <TextControl
                                ...
                                value={memberPhone}
                                onChange={(val) => setAttributes({ memberPhone: val })}
                                type="tel"
                            />
                            ...
                            <PanelColorSettings
                                title={__('Contact Colors', 'twork-builder')}
                                colorSettings={[
                                    {
                                        value: contactIconColor,
                                        onChange: (val) => setAttributes({ contactIconColor: val }),
                            ...
                            <RangeControl
                                ...
                                onChange={(val) => setAttributes({ contactFontSize: val })}
                                min={0.7}
                                max={1.5}
                                step={0.05}
                            />
                ...
                >
                    <ToggleControl
                        ...
                        onChange={(val) => setAttributes({ showSocialLinks: val })}
                    />

                    {showSocialLinks && (
                        <>
                            <TextControl
                                label={__('Facebook URL', 'twork-builder')}
                            ...
                            <TextControl
                                label={__('Twitter URL', 'twork-builder')}
                                value={socialTwitter}
                                onChange={(val) => setAttributes({ socialTwitter: val })}
                                type="url"
                            />

                            <TextControl
                                label={__('LinkedIn URL', 'twork-builder')}
                            ...
                            <TextControl
                                label={__('Instagram URL', 'twork-builder')}
                            ...
                            <RangeControl
                                ...
                                onChange={(val) => setAttributes({ socialIconSize: val })}
                                min={0.8}
                                max={2}
                                step={0.1}
                            />
                                ...
                                colorSettings={[
                                    {
                                        ...
                                        onChange: (val) => setAttributes({ socialIconColor: val }),
                                        label: __('Icon Color', 'twork-builder')
                                    },
                                    {
                                        value: socialIconHoverColor,
                                        onChange: (val) => setAttributes({ socialIconHoverColor: val }),
                                        label: __('Icon Hover Color', 'twork-builder')
                                    },
                                    {
                                        value: socialIconBgColor,
                                        onChange: (val) => setAttributes({ socialIconBgColor: val }),
                                        label: __('Background Color', 'twork-builder')
                                    },
                                    {
                                        value: socialIconBgHoverColor,
                                        onChange: (val) => setAttributes({ socialIconBgHoverColor: val }),
                            ...
                            <RangeControl
                                ...
                                onChange={(val) => setAttributes({ socialIconBorderRadius: val })}
                                min={0}
                                max={50}
                                step={5}
                            />
                ...
                >
                    <SelectControl
                        ...
                        value={cardStyle}
                        options={[
                            { label: __('Default (Solid)', 'twork-builder'), value: 'default' },
                            { label: __('Gradient', 'twork-builder'), value: 'gradient' }
                        ]}
                    ...
                    {cardStyle === 'default' ? (
                        ...
                        <>
                                ...
                                colorSettings={[
                                    {
                                        ...
                                        onChange: (val) => setAttributes({ cardBackgroundGradientStart: val }),
                                        label: __('Start Color', 'twork-builder')
                                    },
                                    {
                                        value: cardBackgroundGradientEnd,
                                        onChange: (val) => setAttributes({ cardBackgroundGradientEnd: val }),
                            ...
                            <RangeControl
                                ...
                                onChange={(val) => setAttributes({ cardBackgroundGradientAngle: val })}
                                min={0}
                                max={360}
                                step={15}
                            />
            ...
            <div {...blockProps}>
                ...
                <div style={{
                    ...
                    <RichText
                        tagName="h3"
                        value={memberName}
                        onChange={(val) => setAttributes({ memberName: val })}
                    ...
                    <RichText
                        ...
                        onChange={(val) => setAttributes({ memberPosition: val })}
                    ...
                    {showBio && (
                        <RichText
                            tagName="p"
                            value={memberBio}
                            onChange={(val) => setAttributes({ memberBio: val })}
                        ...
                        <div style={{ marginBottom: '15px' }}>
                            {memberEmail && (
                                <div style={{
                                    ...
                                    <i className="fa fa-envelope" style={{ color: contactIconColor }} />
                            ...
                            {memberPhone && (
                                <div style={{
                                    ...
                                    <i className="fa fa-phone" style={{ color: contactIconColor }} />
                    ...
                    {showSocialLinks && (socialFacebook || socialTwitter || socialLinkedin || socialInstagram) && (
                        <div style={{
                            display: 'flex',
                            gap: '10px',
