...
export default function save({ attributes }) {
    ...
    return (
        <div {...blockProps}>
            {memberImage && (
                <div className="member-image-wrapper" style={{ position: 'relative' }}>
                    <img
                        src={memberImage}
                        alt={memberName}
            ...
            >
                ...
                {showSpecializations && specializations && specializations.length > 0 && (
                    <div 
                ...
                {showContactInfo && (memberEmail || memberPhone) && (
                    <div className="member-contact" style={{ marginBottom: '15px' }}>
                        {memberEmail && (
                            <div 
                            ...
                            >
                                <i className="fa fa-envelope" style={{ color: contactIconColor }} aria-hidden="true" />
                                <a href={`mailto:${memberEmail}`} style={{ color: 'inherit', textDecoration: 'none' }}>
                                    {memberEmail}
                                </a>
                            </div>
                        )}
                        {memberPhone && (
                            ...
                            >
                                <i className="fa fa-phone" style={{ color: contactIconColor }} aria-hidden="true" />
                                <a href={`tel:${memberPhone}`} style={{ color: 'inherit', textDecoration: 'none' }}>
                                    {memberPhone}
                                </a>
                            </div>
                        )}
