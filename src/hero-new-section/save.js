...
export default function save( { attributes } ) {
	...
	const primaryButtonTarget = primaryButtonOpenInNewTab
		? '_blank'
		: undefined;
	const primaryButtonRel = primaryButtonOpenInNewTab
		? 'noopener noreferrer'
		: undefined;
	const secondaryButtonTarget = secondaryButtonOpenInNewTab
		? '_blank'
		: undefined;
	const secondaryButtonRel = secondaryButtonOpenInNewTab
		? 'noopener noreferrer'
		: undefined;
		...
		<section { ...blockProps }>
			...
			{ hasSlideshow && (
				<div
					...
					data-slideshow-position={
						slideshowImagePosition || 'center'
					}
				>
							...
							{ showPrimaryButton && (
								<a
									...
									style={ {
										...
										...( primaryButtonHoverBgColor && {
											'--hero-primary-hover-bg':
												primaryButtonHoverBgColor,
										} ),
										...( primaryButtonHoverTextColor && {
											'--hero-primary-hover-color':
												primaryButtonHoverTextColor,
										} ),
									} }
								>
							...
							{ showSecondaryButton && (
								<a
									...
									style={ {
										...
										...( secondaryButtonHoverBgColor && {
											'--hero-secondary-hover-bg':
												secondaryButtonHoverBgColor,
										} ),
										...( secondaryButtonHoverTextColor && {
											'--hero-secondary-hover-color':
												secondaryButtonHoverTextColor,
										} ),
									} }
								>
