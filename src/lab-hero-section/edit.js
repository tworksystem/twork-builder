...
export default function Edit({ attributes = {}, setAttributes }) {
    ...
    const addStat = () => {
        setAttributes({
            stats: [
                ...(stats || []),
                { value: __('100+', 'twork-builder'), label: __('New stat', 'twork-builder') },
            ],
        });
    };
    ...
    return (
        <>
            <InspectorControls>
                <PanelBody title={__('Hero background', 'twork-builder')} initialOpen={true}>
                ...
                <PanelBody title={__('Stats bubbles', 'twork-builder')} initialOpen={false}>
                ...
                <PanelBody title={__('Animation', 'twork-builder')} initialOpen={false}>
                    <ToggleControl
                        ...
                        help={__('Adds fade-up class to content and stats for GSAP/ScrollTrigger.', 'twork-builder')}
                    />
                </PanelBody>
            </InspectorControls>
                ...
                <div className="lab-container" style={containerStyle}>
                    <div className={`lab-hero-content ${animationOnScroll ? 'fade-up' : ''}`}>
                        <RichText
                            ...
                            placeholder={__('ISO 15189 Certified', 'twork-builder')}
                        />
                        <RichText
                            tagName="h1"
                            value={title}
                            ...
                            multiline="br"
                            placeholder={__('Precision Science, Accurate Diagnosis.', 'twork-builder')}
                        />
                        <RichText
                            tagName="p"
                            value={description}
                        ...
                        <div className="lab-hero-actions">
                            <RichText
                                ...
                                placeholder={__('Check Prices', 'twork-builder')}
                            ...
                            <RichText
                                ...
                                placeholder={__('Home Visit', 'twork-builder')}
