...
export default function save({ attributes }) {
    ...
    const blockProps = useBlockProps.save({
        className: 'twork-nearby-accommodation-section section-padding services-section',
        style: {
        ...
        <section {...blockProps}>
            ...
            >
                {(showSectionTitle || showSectionDescription) && (
                    <div className="section-header" style={{ marginBottom: showSectionTitle ? sectionTitleMarginBottom : 20 }}>
                        {showSectionTitle && (
                            <RichText.Content
                                tagName="h2"
                                value={sectionTitle}
