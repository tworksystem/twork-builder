				...
				<InspectorControls>
					...
					>
						<ToggleControl
							...
							help={ __(
								'Toggle the section title on/off.',
								'twork-builder'
							) }
						/>
					...
					<PanelBody
						title={ __( 'Section Description', 'twork-builder' ) }
						initialOpen={ false }
					>
						<ToggleControl
							...
							help={ __(
								'Toggle the section description below the title on/off.',
								'twork-builder'
							) }
						/>
						...
						{ showSectionDescription && (
							<>
								<TextControl
									...
									help={ __(
										'Optional intro text below the section title.',
										'twork-builder'
									) }
									multiline
									rows={ 3 }
							...
							{ showSectionTitle && (
								<RichText
									...
									style={ {
										...
										marginBottom: showSectionDescription
											? 12
											: 0,
									} }
								/>
