        ...
        <section {...blockProps}>
            <div className="contact-layout" style={layoutStyle}>
                ...
                <div className="contact-form-wrapper animate-up">
                    <RichText.Content tagName="h3" value={formTitle} className="form-title" />
                    <form id={formId || 'contactForm'}>
                        <div className="form-group">
                            <input type="text" id="name" className="form-control" placeholder=" " required />
                            <label htmlFor="name" className="form-label">{formNameLabel}</label>
                        </div>
                        <div className="form-group">
                            <input type="tel" id="phone" className="form-control" placeholder=" " required />
                            <label htmlFor="phone" className="form-label">{formPhoneLabel}</label>
                        </div>
                        <div className="form-group">
                            <textarea id="message" className="form-control" placeholder=" " required rows={4} />
                            <label htmlFor="message" className="form-label">{formMessageLabel}</label>
                        </div>
                        <button type="submit" className="jivaka-btn btn-primary" style={{ width: '100%', border: 'none' }}>
                            {buttonText}
                        </button>
                    </form>
                </div>
