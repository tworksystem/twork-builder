            ...
            <InspectorControls>
                <PanelBody title={__('FAQ Item', 'twork-builder')} initialOpen={true}>
                    <TextControl
                        ...
                        help={__('Plain text question shown in the accordion header.', 'twork-builder')}
                    />
                    <TextControl
                        ...
                        multiline
                        help={__('Supports HTML (e.g. <strong>). For rich formatting, edit in the block below.', 'twork-builder')}
                    />
                </PanelBody>
            </InspectorControls>
            <div {...blockProps}>
