    ...
    return (
        <section {...blockProps}>
            ...
            <div 
                ...
                style={timelineBg ? { backgroundImage: `url(${timelineBg})` } : {}}
            >
                        ...
                        {timelineItems.map((item, index) => (
                            ...
                            >
                                    ...
                                    <div className="number">
                                        ...
                                        <span className="mobile-arrow-icon">
                                            <svg width="8" height="10" viewBox="0 0 8 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M1.53857 8.6698L6.46147 5.03804" stroke="#003594" strokeWidth="2" strokeMiterlimit="10" strokeLinecap="round"/>
                                                <path d="M1.53857 1.33729L6.46147 4.97595" stroke="#003594" strokeWidth="2" strokeMiterlimit="10" strokeLinecap="round"/>
                                            </svg>    
                                        </span>
                                    </div>
                                ...
                                <div 
                                    ...
                                    style={{
                                        maxHeight: index === activeIndex ? '2000px' : '0',
