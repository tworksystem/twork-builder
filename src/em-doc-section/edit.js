...
const TEMPLATE = [
  [
    'twork/em-doc-card',
    {
      imageUrl: 'https://jivakahospital.com/wp-content/uploads/2025/12/img-team-member-03.jpg',
          ...
          {showSectionHeader && (
            <div className={`em-header ${headerAnimClass}`} style={headerStyle}>
              <RichText
                ...
                value={sectionTitle}
                onChange={(val) => setAttributes({ sectionTitle: val })}
                placeholder={__('Emergency Specialists', 'twork-builder')}
                style={{
              ...
              {showSectionSubtitle && (
                <RichText
                  ...
                  value={sectionSubtitle}
                  onChange={(val) => setAttributes({ sectionSubtitle: val })}
                  placeholder={__('Add optional subtitle…', 'twork-builder')}
                  style={{
