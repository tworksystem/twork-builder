...
export default function save( { attributes } ) {
	...
	const blockProps = useBlockProps.save( {
		...
		'data-timeline-content-box-shadow-spread':
			timelineContentBoxShadowSpread,
		'data-timeline-content-box-shadow-offset-x':
			timelineContentBoxShadowOffsetX,
		'data-timeline-content-box-shadow-offset-y':
			timelineContentBoxShadowOffsetY,
	} );
				...
				<div
					...
					style={ {
						...
						'--timeline-progress-color':
							timelineProgressColor || '#f48b2a',
						'--timeline-dot-size': `${ timelineDotSize || 20 }px`,
						'--timeline-dot-border-width': `${
							timelineDotBorderWidth || 4
						}px`,
						'--timeline-dot-color': timelineDotColor || '#f48b2a',
						'--timeline-item-gap': `${ timelineItemGap || 80 }px`,
						'--timeline-content-border-radius': `${
							timelineContentBorderRadius || 10
						}px`,
						'--timeline-content-box-shadow':
							timelineContentBoxShadow
								? `${
										timelineContentBoxShadowOffsetX || 0
								  }px ${
										timelineContentBoxShadowOffsetY || 5
								  }px ${
										timelineContentBoxShadowBlur || 15
								  }px ${
										timelineContentBoxShadowSpread || 0
								  }px ${
										timelineContentBoxShadowColor ||
										'rgba(0, 0, 0, 0.05)'
								  }`
