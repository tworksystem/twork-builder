        ...
        <>
            <InspectorControls>
                ...
                <PanelBody title={__('Container', 'twork-builder')} initialOpen={false}>
                    ...
                    />
                    <RangeControl
                        label={__('FAQ content max-width (px)', 'twork-builder')}
                    ...
                    {showSectionTitle && (
                        ...
                        >
                            <RichText
                                ...
                                placeholder={__('Common Questions', 'twork-builder')}
                            />
                        </div>
                    )}

                    <div className="phy-faq-wrapper fade-up" style={faqWrapperStyle}>
                        <InnerBlocks
