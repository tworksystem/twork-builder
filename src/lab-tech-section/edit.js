...
export default function Edit({ attributes, setAttributes }) {
    ...
    const blockProps = useBlockProps({
        className: 'lab-section twork-lab-tech-section-editor lab-tech-section-editor',
        style: {
            backgroundColor,
                    ...
                    <PanelColorSettings
                        ...
                        colorSettings={[
                            ...
                            },
                            {
                                ...
                                onChange: (val) => setAttributes({ sectionTitleColor: val ?? undefined }),
                                label: __('Section title (H2)', 'twork-builder'),
                            },
                            {
                                value: sectionSubtitleColor,
                                onChange: (val) => setAttributes({ sectionSubtitleColor: val ?? undefined }),
                                label: __('Section subtitle', 'twork-builder'),
                            },
                        ]}
                    />
                    <PanelColorSettings
                        ...
                        colorSettings={[
                            {
                                ...
                                label: __('Primary / accent', 'twork-builder'),
                            },
                            {
                                value: itemTagBgColor,
                                onChange: (val) => setAttributes({ itemTagBgColor: val ?? undefined }),
                                label: __('Tag background', 'twork-builder'),
                            },
                            {
                                value: itemTagColor,
                                onChange: (val) => setAttributes({ itemTagColor: val ?? undefined }),
                                label: __('Tag text', 'twork-builder'),
                            },
                            {
                                value: itemTitleColor,
                                onChange: (val) => setAttributes({ itemTitleColor: val ?? undefined }),
                                label: __('Item title (H3)', 'twork-builder'),
                            },
                            {
                                value: itemDescriptionColor,
                                onChange: (val) => setAttributes({ itemDescriptionColor: val ?? undefined }),
                                label: __('Item description', 'twork-builder'),
                            },
                            {
                                value: itemBulletColor,
                                onChange: (val) => setAttributes({ itemBulletColor: val ?? undefined }),
                                label: __('Bullet text', 'twork-builder'),
                            },
                            {
                                value: itemBulletIconColor,
                                onChange: (val) => setAttributes({ itemBulletIconColor: val ?? undefined }),
