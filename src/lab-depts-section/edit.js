...
const Divider = StableDivider || ExperimentalDivider || function DividerFallback() {
    return <hr style={{ margin: '16px 0', border: 'none', borderTop: '1px solid rgba(0,0,0,0.12)' }} />;
};

const ALLOWED_BLOCKS = ['twork/lab-dept-card'];
const TEMPLATE = [
    ['twork/lab-dept-card', { iconClass: 'fas fa-flask', title: 'Biochemistry' }],
    ['twork/lab-dept-card', { iconClass: 'fas fa-tint', title: 'Hematology' }],
    ['twork/lab-dept-card', { iconClass: 'fas fa-dna', title: 'Molecular Bio' }],
    ['twork/lab-dept-card', { iconClass: 'fas fa-bacterium', title: 'Microbiology' }],
    ['twork/lab-dept-card', { iconClass: 'fas fa-microscope', title: 'Histopathology' }],
    ['twork/lab-dept-card', { iconClass: 'fas fa-vial', title: 'Clinical Path' }],
];
            ...
            <InspectorControls>
                        ...
                        colorSettings={[
                            {
                                ...
                                onChange: (val) => setAttributes({ backgroundColor: val ?? undefined }),
                                label: __('Section background', 'twork-builder'),
                            },
                            {
                                value: cardBackgroundColor,
                                onChange: (val) => setAttributes({ cardBackgroundColor: val ?? undefined }),
                                label: __('Card background', 'twork-builder'),
                            },
                            {
                                value: hexIconBgColor,
                                onChange: (val) => setAttributes({ hexIconBgColor: val ?? undefined }),
                                label: __('Hex icon background', 'twork-builder'),
                            },
                        ]}
                    />
                    <PanelColorSettings
                        ...
                        colorSettings={[
                            {
                                value: headingColor,
                                onChange: (val) => setAttributes({ headingColor: val ?? undefined }),
                                label: __('Heading (H2, H3)', 'twork-builder'),
                            },
                            {
                                value: subtitleColor,
                                onChange: (val) => setAttributes({ subtitleColor: val ?? undefined }),
                                label: __('Subtitle', 'twork-builder'),
                            },
                            {
                                value: primaryColor,
                                onChange: (val) => setAttributes({ primaryColor: val ?? undefined }),
                                label: __('Primary / accent (icon, hover)', 'twork-builder'),
                            },
                        ]}
                    />
                </PanelBody>
                <PanelBody title={__('Section layout', 'twork-builder')} initialOpen={true}>
                    <RangeControl
                ...
                <PanelBody title={__('Header', 'twork-builder')} initialOpen={true}>
                    ...
                    <SelectControl
                        ...
                        value={headerAlign}
                        options={[
                            { value: 'left', label: __('Left', 'twork-builder') },
                            { value: 'center', label: __('Center', 'twork-builder') },
                            { value: 'right', label: __('Right', 'twork-builder') },
                        ]}
                        onChange={(val) => setAttributes({ headerAlign: val || 'center' })}
                    />
                </PanelBody>
                ...
                <PanelBody title={__('Animation', 'twork-builder')} initialOpen={false}>
                    <ToggleControl
                        label={__('Enable fade-up header/cards classes', 'twork-builder')}
                    ...
                    {showSectionHeader && (
                        ...
                        >
                            <RichText
                                ...
                                placeholder={__('Our Departments', 'twork-builder')}
                            />
                            <RichText
                                tagName="p"
