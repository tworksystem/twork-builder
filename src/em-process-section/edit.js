...
const TEMPLATE = [
  ['twork/em-process-step', { stepNumber: '1', title: 'Arrival', description: 'Ambulance or walk-in.' }],
  ['twork/em-process-step', { stepNumber: '2', title: 'Triage', description: 'Quick severity assessment.' }],
  ['twork/em-process-step', { stepNumber: '3', title: 'Diagnosis', description: 'Rapid labs and imaging.' }],
  ['twork/em-process-step', { stepNumber: '4', title: 'Treatment', description: 'Surgery or ICU admission.' }],
];
...
export default function Edit({ attributes, setAttributes }) {
  ...
  const headerAnimClass = animationOnScroll && animationType ? animationType : '';
  ...
  return (
    <>
      <InspectorControls>
        ...
        <PanelBody title={__('Process grid', 'twork-builder')} initialOpen={false}>
          <RangeControl
        ...
        <PanelBody title={__('Animation', 'twork-builder')} initialOpen={false}>
          ...
          {animationOnScroll && (
            <>
              ...
              />
              <RangeControl
                label={__('Stagger delay per step (ms)', 'twork-builder')}
      ...
      <section {...blockProps}>
        <div className="em-container" style={containerStyle}>
          {showSectionHeader && (
            <div className={`em-header ${headerAnimClass}`} style={headerStyle}>
              <RichText
                tagName="h2"
                value={sectionTitle}
                onChange={(val) => setAttributes({ sectionTitle: val })}
                placeholder={__('Our Emergency Process', 'twork-builder')}
                style={{
              ...
              <RichText
                ...
                value={sectionSubtitle}
                onChange={(val) => setAttributes({ sectionSubtitle: val })}
                placeholder={__('We prioritize speed and precision.', 'twork-builder')}
                style={{
          ...
          <div className="em-process-grid" style={gridStyle} data-columns={columns}>
            <InnerBlocks
