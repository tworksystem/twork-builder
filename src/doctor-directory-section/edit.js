        ...
        <>
            <InspectorControls>
                ...
                >
                    <TextControl
                        ...
                        onChange={(val) => setAttributes({ noResultsHeading: val })}
                        help={__('Shown when no doctors match the current filters.', 'twork-builder')}
                    />
                    <TextControl
                        label={__('Message', 'twork-builder')}
                        value={noResultsMessage}
                        onChange={(val) => setAttributes({ noResultsMessage: val })}
                    />
                </PanelBody>
            </InspectorControls>
            ...
            <div {...blockProps}>
                <div style={containerStyle}>
                    ...
                    >
                        {__('No results message (shown on frontend when filters match nothing)', 'twork-builder')}
                    </div>
                </div>
            </div>
        </>
