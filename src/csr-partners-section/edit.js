        ...
        <>
            <InspectorControls>
                ...
                <PanelBody title={__('Logo Styling', 'twork-builder')} initialOpen={true}>
                    ...
                    />
                    <ToggleControl
                        label={__('Grayscale (color on hover)', 'twork-builder')}
                        checked={logoGrayscale}
                        onChange={(val) => setAttributes({ logoGrayscale: val })}
                        help={__('Logos in grayscale by default, full color on hover.', 'twork-builder')}
                    />
                    <Divider />
                    <RangeControl
                ...
                <div className="jivaka-container" style={containerStyle}>
                    {showSectionTitle && (
                        <RichText
                            ...
                            value={sectionTitle}
                            onChange={(val) => setAttributes({ sectionTitle: val })}
                            placeholder={__('In Collaboration With', 'twork-builder')}
                    ...
                    <div
                        className={`logo-grid${animationOnScroll ? ' fade-up' : ''} twork-csr-partners-grid`}
                        style={gridStyle}
                    >
                        <InnerBlocks
