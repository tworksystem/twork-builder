        ...
        <>
            <InspectorControls>
                ...
                >
                    ...
                    {showSectionTitle && (
                        <>
                            ...
                            <RangeControl
                                ...
                                max={3}
                                step={0.1}
                                help={__('Font size for mobile devices (<768px)', 'twork-builder')}
                            />
                    ...
                    {showSectionSubtitle && (
                        <>
                            ...
                            <RangeControl
                                label={__('Subtitle Font Size - Desktop (rem)', 'twork-builder')}
                ...
                <PanelBody
                    ...
                    initialOpen={false}
                >
                    <BaseControl label={__('Background Type', 'twork-builder')}>
                        {!backgroundImage ? (
                            <MediaPlaceholder
                ...
                >
                    <RangeControl
                        ...
                        max={6}
                        step={1}
                        help={__('Number of columns on desktop screens (≥992px)', 'twork-builder')}
                    />
                    ...
                    <RangeControl
                        ...
                        max={4}
                        step={1}
                        help={__('Number of columns on tablet screens (768px - 991px)', 'twork-builder')}
                    />
                    ...
                    <RangeControl
                        ...
                        max={2}
                        step={1}
                        help={__('Number of columns on mobile screens (<768px)', 'twork-builder')}
                    />

                    <Divider />

                    <RangeControl
                        label={__('Gap Between Items - Desktop (px)', 'twork-builder')}
                        value={gap}
                    ...
                    <RangeControl
                        label={__('Gap Between Items - Mobile (px)', 'twork-builder')}
                        value={gapMobile}
                        onChange={(val) => setAttributes({ gapMobile: val })}
                        min={0}
                        max={40}
                        step={1}
                        help={__('Gap between items on mobile devices', 'twork-builder')}
                    />
                ...
                <PanelBody
                    ...
                    initialOpen={false}
                >
                    <BaseControl label={__('Item Borders Control', 'twork-builder')}>
                        <ToggleControl
                            label={__('Disable All Borders', 'twork-builder')}
                            checked={disableAllBorders}
                            onChange={(val) => {
                                setAttributes({ 
                                    disableAllBorders: val,
                                    showBorder: !val,
                                    showBorderDesktop: !val ? showBorderDesktop : false,
                                    showBorderTablet: !val ? showBorderTablet : false,
                                    showBorderMobile: !val ? showBorderMobile : false
                                });
                            }}
                            help={__('Completely disable all borders between items. When enabled, all border settings are ignored.', 'twork-builder')}
                        />
                    </BaseControl>
                    ...
                    {!disableAllBorders && (
                        <>
                            ...
                            <ToggleControl
                                label={__('Enable Borders Between Items', 'twork-builder')}
                                checked={showBorder}
                                onChange={(val) => setAttributes({ showBorder: val })}
                                help={__('Show borders between service items', 'twork-builder')}
                            />
                        </>
                    )}
                    ...
                    {!disableAllBorders && showBorder && (
                        <>
                            ...
                            <BaseControl label={__('Border Visibility by Device', 'twork-builder')}>
                                <ToggleControl
                                    label={__('Show on Desktop', 'twork-builder')}
                                    checked={showBorderDesktop}
                                    onChange={(val) => setAttributes({ showBorderDesktop: val })}
                                    help={__('Display borders on desktop screens (≥992px)', 'twork-builder')}
                                />

                                <ToggleControl
                                    label={__('Show on Tablet', 'twork-builder')}
                                    checked={showBorderTablet}
                                    onChange={(val) => setAttributes({ showBorderTablet: val })}
                                    help={__('Display borders on tablet screens (768px - 991px)', 'twork-builder')}
                                />

                                <ToggleControl
                                    label={__('Show on Mobile', 'twork-builder')}
                                    checked={showBorderMobile}
                                    onChange={(val) => setAttributes({ showBorderMobile: val })}
                                    help={__('Display borders on mobile screens (<768px)', 'twork-builder')}
                                />
                            </BaseControl>
                            ...
                            <SelectControl
                                label={__('Border Position', 'twork-builder')}
                                value={borderPosition}
                                options={[
                                    { label: __('Vertical (Between Columns)', 'twork-builder'), value: 'vertical' },
                                    { label: __('Horizontal (Between Rows)', 'twork-builder'), value: 'horizontal' },
                                    { label: __('Both (Grid Style)', 'twork-builder'), value: 'both' }
                                ]}
                                onChange={(val) => setAttributes({ borderPosition: val })}
                                help={__('Where to display borders between items', 'twork-builder')}
                            />
                            ...
                            <PanelColorSettings
                                ...
                                colorSettings={[
                                    ...
                                    },
                                    {
                                        ...
                                        onChange: (val) => setAttributes({ borderColorHover: val }),
                            ...
                            <BaseControl label={__('Border Width', 'twork-builder')}>
                                <RangeControl
                                    label={__('Border Width - Desktop (px)', 'twork-builder')}
                                    value={borderWidth}
                                    onChange={(val) => setAttributes({ borderWidth: val })}
                                    min={0}
                                    max={10}
                                    step={0.5}
                                    help={__('Border thickness on desktop screens', 'twork-builder')}
                                />

                                <RangeControl
                                    label={__('Border Width - Mobile (px)', 'twork-builder')}
                                    value={borderWidthMobile}
                                    onChange={(val) => setAttributes({ borderWidthMobile: val })}
                                    min={0}
                                    max={10}
                                    step={0.5}
                                    help={__('Border thickness on mobile devices', 'twork-builder')}
                                />
                            </BaseControl>
                            ...
                            <SelectControl
                                ...
                                options={[
                                    ...
                                    { label: __('Groove', 'twork-builder'), value: 'groove' },
                                    { label: __('Ridge', 'twork-builder'), value: 'ridge' },
                                    { label: __('Inset', 'twork-builder'), value: 'inset' },
                                    { label: __('Outset', 'twork-builder'), value: 'outset' }
                                ]}
                            ...
                            <RangeControl
                                ...
                                value={borderOpacity}
                                onChange={(val) => setAttributes({ borderOpacity: val })}
                                min={0}
                                max={1}
                                step={0.1}
                ...
                <PanelBody
                    title={__('Section Border & Shadow', 'twork-builder')}
                    initialOpen={false}
                >
                    <BaseControl label={__('Section Border', 'twork-builder')}>
                        <RangeControl
                            label={__('Border Width (px)', 'twork-builder')}
                            value={sectionBorderWidth}
                            onChange={(val) => setAttributes({ sectionBorderWidth: val })}
                            min={0}
                            max={20}
                            step={1}
                            help={__('Border width around the entire section', 'twork-builder')}
                        />
                        ...
                        {sectionBorderWidth > 0 && (
                            <>
                                    ...
                                    colorSettings={[
                                        {
                                            ...
                                            onChange: (val) => setAttributes({ sectionBorderColor: val }),
                                            label: __('Border Color', 'twork-builder')
                                        }
                                    ]}
                                />
                                ...
                                <SelectControl
                                    ...
                                    onChange={(val) => setAttributes({ sectionBorderStyle: val })}
                                />

                                <RangeControl
                                    label={__('Border Radius (px)', 'twork-builder')}
                                    value={sectionBorderRadius}
                                    onChange={(val) => setAttributes({ sectionBorderRadius: val })}
                                    min={0}
                                    max={50}
                                    step={1}
                                    help={__('Rounded corners for the section', 'twork-builder')}
                                />
                            </>
                        )}
                    </BaseControl>
                    ...
                    <BaseControl label={__('Box Shadow', 'twork-builder')}>
                        <ToggleControl
                            label={__('Enable Box Shadow', 'twork-builder')}
                            checked={sectionBoxShadow}
                            onChange={(val) => setAttributes({ sectionBoxShadow: val })}
                            help={__('Add shadow effect to the section', 'twork-builder')}
                        />
                        ...
                        {sectionBoxShadow && (
                            <>
                                    ...
                                    colorSettings={[
                                        {
                                            ...
                                            onChange: (val) => setAttributes({ sectionBoxShadowColor: val }),
                                ...
                                <RangeControl
                                    label={__('Horizontal Offset (px)', 'twork-builder')}
                                    value={sectionBoxShadowX}
                                    onChange={(val) => setAttributes({ sectionBoxShadowX: val })}
                                    min={-50}
                                    max={50}
                                    step={1}
                                    help={__('Horizontal shadow position', 'twork-builder')}
                                />

                                <RangeControl
                                    label={__('Vertical Offset (px)', 'twork-builder')}
                                    value={sectionBoxShadowY}
                                    onChange={(val) => setAttributes({ sectionBoxShadowY: val })}
                                    min={-50}
                                    max={50}
                                    step={1}
                                    help={__('Vertical shadow position', 'twork-builder')}
                                />

                                <RangeControl
                                    label={__('Blur Radius (px)', 'twork-builder')}
                                    value={sectionBoxShadowBlur}
                                    onChange={(val) => setAttributes({ sectionBoxShadowBlur: val })}
                                    min={0}
                                    max={100}
                                    step={1}
                                    help={__('Shadow blur amount', 'twork-builder')}
                                />

                                <RangeControl
                                    label={__('Spread Radius (px)', 'twork-builder')}
                                    value={sectionBoxShadowSpread}
                                    onChange={(val) => setAttributes({ sectionBoxShadowSpread: val })}
                                    min={-50}
                                    max={50}
                                    step={1}
                                    help={__('Shadow spread amount', 'twork-builder')}
                                />
                            </>
                        )}
                    </BaseControl>
                ...
                >
                    ...
                    <RangeControl
                        label={__('Container Padding - Desktop (px)', 'twork-builder')}
                        value={containerPadding}
                        onChange={(val) => setAttributes({ containerPadding: val })}
                        min={0}
                        max={100}
                        step={5}
                        help={__('Horizontal padding for the container on desktop', 'twork-builder')}
                    />
                    ...
                    <RangeControl
                        ...
                        max={60}
                        step={5}
                        help={__('Horizontal padding for the container on mobile', 'twork-builder')}
                    />
                    ...
                    <RangeControl
                        ...
                        max={150}
                        step={5}
                        help={__('Top padding for mobile devices', 'twork-builder')}
                    />
                    ...
                    <RangeControl
                        ...
                        max={150}
                        step={5}
                        help={__('Bottom padding for mobile devices', 'twork-builder')}
                    />
                </PanelBody>
                ...
                >
                    <ToggleControl
                        ...
                        help={__('Enable hover animations for service items', 'twork-builder')}
                    />
            ...
            <div {...blockProps}>
                ...
                <div style={containerStyle}>
                    <div className="editor-label" style={{
                        ...
                        {__('Key Services Section (Editor View)', 'twork-builder')}
                    </div>
