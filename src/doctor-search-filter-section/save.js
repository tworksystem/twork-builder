...
export default function save({ attributes }) {
    ...
    const blockProps = useBlockProps.save({
        ...
        style: {
            ...
            marginBottom: sectionMarginBottom !== undefined ? `${sectionMarginBottom}px` : undefined,
            position: 'relative',
            zIndex: 10,
            '--twork-search-section-margin-top': `${marginTopPx}px`,
            '--twork-search-section-margin-bottom': sectionMarginBottom !== undefined ? `${sectionMarginBottom}px` : undefined,
            '--twork-search-label-color': labelColor || undefined,
            '--twork-search-input-border': inputBorderColor || undefined,
            '--twork-search-input-focus-border': inputFocusBorderColor || undefined,
            ...
            '--twork-search-reset-hover-color': resetButtonHoverColor || undefined
        }
    });
    ...
    const containerStyle = {
        ...
        margin: '0 auto',
        padding: containerPadding !== undefined ? `0 ${containerPadding}px` : undefined,
        position: 'relative'
    };
    ...
    const searchBoxStyle = {
        ...
        borderRadius: boxBorderRadius !== undefined ? `${boxBorderRadius}px` : undefined,
        borderTop: boxBorderTopWidth ? `${boxBorderTopWidth}px solid ${boxBorderTopColor || '#f48b2a'}` : undefined
    };

    const sectionClass = addAnimationClass ? 'search-section animate-hero' : 'search-section';
                    ...
                    <div className="search-box" style={searchBoxStyle}>
                        <div className="filter-group">
                            ...
                            <input
                                ...
                                placeholder={searchPlaceholder || 'Type name e.g. Kyaw'}
                                autoComplete="off"
                        ...
                        <div className="filter-group">
                            ...
                            <select id="deptFilter" className="filter-input" aria-label={departmentLabel || 'Department'}>
                                <option value="all">{departmentAllLabel || 'All Departments'}</option>
                        ...
                        <div className="filter-group">
                            ...
                            <select id="genderFilter" className="filter-input" aria-label={genderLabel || 'Gender'}>
                                <option value="all">{genderAllLabel || 'All Genders'}</option>
                        ...
                        <div className="search-btn-wrapper">
                            <button type="button" className="btn-reset" id="resetBtn" aria-label={resetButtonText || 'Reset filters'}>
