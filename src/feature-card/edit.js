...
export default function Edit({ attributes, setAttributes }) {
    ...
    return (
        <>
            <InspectorControls>
                <PanelBody title={__('Feature Card', 'twork-builder')} initialOpen={true}>
                    <TextControl
                        ...
                        help={__('e.g. fas fa-microscope, fas fa-user-md', 'twork-builder')}
                    />
                    <p style={{ fontSize: '11px', color: '#757575', marginTop: 4 }}>
                        {__('Suggestions:', 'twork-builder')} {ICON_SUGGESTIONS.join(', ')}
                    </p>
                </PanelBody>
            </InspectorControls>
            <div {...blockProps}>
