...
const ALLOWED_BLOCKS = [ 'twork/laparo-hero-float-card' ];
const TEMPLATE = [
	[
		'twork/laparo-hero-float-card',
		{
			positionSlot: 'fc-1',
...
export default function Edit( { attributes, setAttributes, isSelected } ) {
	...
	const blockProps = useStableBlockProps(
		() => ( {
			className: 'twork-laparo-hero-section mk-laparo-hero-section hero',
	...
	return (
		<>
			...
			<header { ...blockProps }>
				...
				<div className="laparo-container" style={ containerStyle }>
