...
const ALLOWED_BLOCKS = [ 'twork/endo-procedure-item' ];
const TEMPLATE = [
	[
		'twork/endo-procedure-item',
		{
			cardLayout: 'wide',
	...
	[
		'twork/endo-procedure-item',
		{
			...
			description:
				'Full inspection of the large bowel with immediate removal of polyps — the single most effective way to prevent colorectal cancer before it starts.',
			chips: [
				{
					showChip: true,
					iconClass: 'fas fa-clock',
	...
	[
		'twork/endo-procedure-item',
		{
			...
			title: 'ERCP',
			description:
				'Endoscopic treatment of bile duct stones, strictures and jaundice — no open surgery needed.',
			chips: [
				{
					showChip: true,
