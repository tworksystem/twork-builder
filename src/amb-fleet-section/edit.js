...
export default function Edit({ attributes, setAttributes }) {
    ...
    const TEMPLATE = [
        ['twork/amb-fleet-card-item', { badgeText: 'Critical Care', badgeStyle: 'dark' }],
        ['twork/amb-fleet-card-item', { badgeText: 'Standard', badgeStyle: 'primary' }]
    ];
        ...
        <>
            <InspectorControls>
                ...
                >
                    ...
                    <ToggleControl
                        ...
                        help={__('Bottom slant effect', 'twork-builder')}
                    />
                </PanelBody>
            ...
            <div {...blockProps}>
                ...
                <div style={containerStyle}>
                    ...
                    >
                        {__('Ambulance Fleet Section (Editor)', 'twork-builder')}
                    </div>
