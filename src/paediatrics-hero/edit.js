...
export default function Edit( { attributes, setAttributes, isSelected } ) {
	...
	const blockProps = useStableBlockProps(
		...
		[ minHeight, paddingBottom, paddingTop ]
	);
				...
				<InspectorControls>
					...
					>
						...
						<TextControl
							...
							onChange={ ( val ) =>
								setAttributes( { outlineButtonText: val } )
							}
						/>
						...
						<TextControl
							...
							onChange={ ( val ) =>
								setAttributes( { outlineButtonUrl: val } )
							}
						/>
						...
						<ToggleControl
							...
							onChange={ ( val ) =>
								setAttributes( { outlineButtonLight: val } )
							}
						/>
					</PanelBody>
