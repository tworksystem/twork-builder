...
const COMMON_ICONS = [
    ...
    { label: __('Stethoscope', 'twork-builder'), value: 'fas fa-stethoscope' },
    { label: __('Pills', 'twork-builder'), value: 'fas fa-pills' },
    { label: __('Users', 'twork-builder'), value: 'fas fa-users' },
    { label: __('Hands Helping', 'twork-builder'), value: 'fas fa-hands-helping' },
...
export default function Edit({ attributes, setAttributes }) {
    ...
    return (
        <>
            <InspectorControls>
                <PanelBody title={__('Image Settings', 'twork-builder')} initialOpen={true}>
                    {!image ? (
                        <MediaPlaceholder
                            ...
                            allowedTypes={['image']}
                            multiple={false}
                            labels={{ title: __('Select Initiative Image', 'twork-builder') }}
                        />
                    ) : (
                        <div>
                            <img
                ...
                <PanelBody title={__('Icon Settings', 'twork-builder')} initialOpen={false}>
                    <SelectControl
                        label={__('Quick Select Icon', 'twork-builder')}
                        value={COMMON_ICONS.find(i => i.value === iconClass) ? iconClass : '__custom__'}
                        options={iconSelectOptions}
                        onChange={(val) => setAttributes({ iconClass: val === '__custom__' ? iconClass || 'fas fa-heart' : val })}
                    />
                    <TextControl
                        label={__('Icon Class (Font Awesome)', 'twork-builder')}
                        value={iconClass}
                        onChange={(val) => setAttributes({ iconClass: val || 'fas fa-heart' })}
                        help={__('e.g., fas fa-ambulance', 'twork-builder')}
                    />
                    <PanelColorSettings
            ...
            <div {...blockProps}>
                {!image ? (
                    <div className="init-img-wrap" style={{
                    ...
                    <div className="init-img-wrap" style={{ height: `${imageHeight}px`, overflow: 'hidden' }}>
                        <img
                            src={image}
                            alt={imageAlt || title || ''}
                            decoding="async"
                ...
                >
                    ...
                    >
                        <i className={iconClass || 'fas fa-heart'} aria-hidden="true" />
                    </div>
                    <RichText
                        tagName="h3"
                        value={title}
                        onChange={(val) => setAttributes({ title: val })}
                        placeholder={__('Initiative title...', 'twork-builder')}
                        style={{
                    ...
                    <RichText
                        ...
                        placeholder={__('Initiative description...', 'twork-builder')}
                        style={{
