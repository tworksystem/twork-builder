            ...
            <InspectorControls>
                ...
                >
                    ...
                    <RangeControl
                        ...
                        onChange={(val) =>
                            setAttributes({ sectionHeaderMarginBottom: val })
                        }
                        min={16}
                        max={80}
                        step={4}
                ...
                >
                    <RangeControl
                        ...
                        max={4}
                        step={1}
                        help={__('Use 1 column for vertical steps like the lab design.', 'twork-builder')}
                    />
                ...
                >
                    ...
                    {animationOnScroll && (
                        <>
                            ...
                            <RangeControl
                                label={__('Animation Stagger (ms)', 'twork-builder')}
            ...
            <div {...blockProps}>
                ...
                <div style={containerStyle}>
                    ...
                    >
                        ...
                        {__('How It Works (Steps Section)', 'twork-builder')}
                    </div>
                        ...
                        <div className="section-header" style={headerStyle}>
                            {showSectionTitle && (
                                <RichText
                                    ...
                                    style={{
                                        ...
                                        marginBottom: showSectionSubtitle ? '8px' : '0'
                                    }}
                                />
                            )}
                            ...
                            {showSectionSubtitle && (
                                <RichText
                                    ...
                                    placeholder={__('Explain the flow in one line…', 'twork-builder')}
