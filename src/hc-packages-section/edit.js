...
const TEMPLATE = [
    ['twork/hc-package-card', {
        ...
        price: '30,000',
        priceUnit: 'MMK / Day',
        features: ['12 Hours Duty', 'Vitals Monitoring', 'Medication Administration', 'Basic Hygiene Care'],
    ...
    ['twork/hc-package-card', {
        ...
        features: ['45-60 Mins Session', 'Manual Therapy', 'Exercise Guidance', 'Pain Management'],
        buttonText: 'Choose Plan',
        buttonUrl: '#',
        buttonStyle: 'primary',
    ...
    ['twork/hc-package-card', {
        ...
        price: '40,000',
        priceUnit: 'MMK / Visit',
        features: ['Comprehensive Checkup', 'Prescription Review', 'Specialist Referral (if needed)', 'Dietary Advice'],
        buttonText: 'Choose Plan',
        buttonUrl: '#',
        buttonStyle: 'outline',
    }],
        ...
        <>
            ...
            <section {...blockProps}>
                <div className="hc-container" style={containerStyle}>
                    {showSectionTitle && (
                        <div className={`hc-header ${animationOnScroll ? animationType : ''}`} style={{ textAlign: 'center', maxWidth: 700, margin: '0 auto 50px' }}>
                            <RichText
                                tagName="h2"
                                value={sectionTitle}
                                onChange={(val) => setAttributes({ sectionTitle: val })}
                                placeholder={__('Care Packages', 'twork-builder')}
                                style={{ color: sectionTitleColor || '#212121', marginBottom: 15 }}
                            />
                            <RichText
                                tagName="p"
                                value={sectionSubtitle}
                                onChange={(val) => setAttributes({ sectionSubtitle: val })}
                                placeholder={__('Affordable plans for long-term recovery.', 'twork-builder')}
                                style={{ color: sectionSubtitleColor || '#555', margin: 0 }}
                            />
                        </div>
                    )}
