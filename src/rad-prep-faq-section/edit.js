...
const TEMPLATE = [
  [
    'twork/rad-faq-item',
    {
      ...
      answer:
        'Yes, usually 4-6 hours of fasting is required for abdominal CT scans, especially if contrast dye is used.',
    },
  ],
  [
    'twork/rad-faq-item',
    {
      ...
      answer:
        'MRI uses magnets, not radiation. However, it is NOT safe if you have metal implants, pacemakers, or older surgical clips.',
    },
  ],
  [
    'twork/rad-faq-item',
    {
      ...
      answer:
        'Emergency X-rays are reported instantly. CT/MRI reports are typically ready within 2-4 hours.',
    },
  ],
  [
    'twork/rad-faq-item',
    {
      ...
      answer:
        'Wear loose, comfortable clothing without zippers or metal buttons. We will provide a hospital gown if needed.',
    },
  ],
];
        ...
        <PanelBody title={__('Image', 'twork-builder')} initialOpen={false}>
          {imageUrl ? (
            ...
            <MediaPlaceholder
              ...
              allowedTypes={['image']}
              labels={{
                title: __('Preparation Image', 'twork-builder'),
              }}
            />
          )}
        </PanelBody>
                ...
                <>
                  {showSectionTitle && (
                    <RichText
                      ...
                      value={sectionTitle}
                      onChange={(val) => setAttributes({ sectionTitle: val })}
                      placeholder={__('Patient Preparation Guide', 'twork-builder')}
                      style={{
                        marginBottom: '20px',
