            ...
            <InspectorControls>
                <PanelBody title={__('Content', 'twork-builder')} initialOpen={true}>
                    ...
                    <TextControl
                        ...
                        help={__('e.g. mailto:hr@example.com', 'twork-builder')}
                    />
                    <TextControl
                        label={__('Button Icon Class', 'twork-builder')}
                        value={ctaButtonIcon}
                        onChange={(val) => setAttributes({ ctaButtonIcon: val })}
                        help={__('Font Awesome class. Leave empty for no icon.', 'twork-builder')}
                    />
                </PanelBody>
                ...
                <PanelBody title={__('Background', 'twork-builder')} initialOpen={false}>
                    <PanelColorSettings
                        ...
                        colorSettings={[
                            { value: ctaBackgroundStart, onChange: (val) => setAttributes({ ctaBackgroundStart: val }), label: __('Gradient Start', 'twork-builder') },
                            { value: ctaBackgroundEnd, onChange: (val) => setAttributes({ ctaBackgroundEnd: val }), label: __('Gradient End', 'twork-builder') }
                        ]}
                    />
                </PanelBody>
                ...
                <div style={containerStyle}>
                    ...
                    >
                        <RichText
                            ...
                            placeholder={__('CTA title...', 'twork-builder')}
                            style={{
                                margin: '0 0 15px 0',
                                fontSize: '2rem',
                                color: '#fff'
                        ...
                        <RichText
                            ...
                            onChange={(val) => setAttributes({ ctaDescription: val })}
                            placeholder={__('CTA description...', 'twork-builder')}
                            style={{
                        ...
                        <div contentEditable={false}>
                            ...
                            >
                                {ctaButtonIcon && <i className={ctaButtonIcon} aria-hidden="true" style={{ marginRight: '8px' }} />}
                                {ctaButtonText}
                            </a>
                        </div>
                    </div>
