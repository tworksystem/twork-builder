...
const ICON_OPTIONS = [
    { label: __('Certificate', 'twork-builder'), value: 'fas fa-certificate' },
    ...
    { label: __('Check Circle', 'twork-builder'), value: 'fas fa-check-circle' },
...
export default function Edit({ attributes, setAttributes }) {
    ...
    const blockProps = useBlockProps({
        className: 'twork-accreditation-cert-card-editor cert-card stagger-up',
        style: {
        ...
        <>
            <InspectorControls>
                <PanelBody title={__('Content', 'twork-builder')} initialOpen={true}>
                    ...
                    />
                    <TextControl
                        label={__('Certification Title', 'twork-builder')}
                        value={certTitle}
                        onChange={(val) => setAttributes({ certTitle: val })}
                        help={__('e.g., ISO 9001:2015, JCI Accreditation', 'twork-builder')}
                    />
                    <TextControl
                        label={__('Badge Text', 'twork-builder')}
                        value={certBadge}
                        onChange={(val) => setAttributes({ certBadge: val })}
                        help={__('e.g., Certified Since 2018, Gold Seal of Approval', 'twork-builder')}
                    />
                    <TextControl
                        label={__('Description', 'twork-builder')}
                        value={certDescription}
                        onChange={(val) => setAttributes({ certDescription: val })}
                        help={__('Short description of the certification', 'twork-builder')}
                    />
                </PanelBody>

                <PanelBody title={__('Icon Styling', 'twork-builder')} initialOpen={false}>
                    <PanelColorSettings
                ...
                <PanelBody title={__('Badge Styling', 'twork-builder')} initialOpen={false}>
                    <PanelColorSettings
                        ...
                        colorSettings={[
                            {
                                ...
                                label: __('Badge Background', 'twork-builder')
                            },
                            {
                    ...
                    />
                    <RangeControl
                        label={__('Badge Font Size (rem)', 'twork-builder')}
                        value={badgeFontSize}
                    ...
                    <RangeControl
                        ...
                        onChange={(val) => setAttributes({ badgeFontWeight: val })}
                        min={400}
                        max={900}
                        step={100}
                    />
                    <RangeControl
                        label={__('Badge Border Radius (px)', 'twork-builder')}
                ...
                <PanelBody title={__('Description Styling', 'twork-builder')} initialOpen={false}>
                    <PanelColorSettings
                ...
                <PanelBody title={__('Card Styling', 'twork-builder')} initialOpen={false}>
                    <PanelColorSettings
                        ...
                        colorSettings={[
                            ...
                            {
                                value: topBarColor,
                                onChange: (val) => setAttributes({ topBarColor: val }),
                                label: __('Hover Top Bar', 'twork-builder')
                            }
                        ]}
                    />
                    <ToggleControl
                        label={__('Show Top Bar on Hover', 'twork-builder')}
                        checked={showTopBarOnHover}
                        onChange={(val) => setAttributes({ showTopBarOnHover: val })}
                    />
                    <RangeControl
                    ...
                    <RangeControl
                        ...
                        onChange={(val) => setAttributes({ cardPaddingHorizontal: val })}
                        min={15}
                        max={50}
                        step={5}
                    />
            ...
            <div {...blockProps}>
                ...
                <RichText
                    ...
                    value={certTitle}
                    onChange={(val) => setAttributes({ certTitle: val })}
                    placeholder={__('Certification title...', 'twork-builder')}
                    style={{
                        margin: '0 0 10px',
