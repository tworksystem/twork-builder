	...
	return (
		<>
			{ isSelected && (
				<InspectorControls>
					<PanelBody
						title={ __( 'Room Image', 'twork-builder' ) }
						initialOpen={ true }
					>
					...
					<PanelBody
						title={ __( 'Price Badge', 'twork-builder' ) }
						initialOpen={ false }
					>
						<TextControl
							label={ __( 'Price Text', 'twork-builder' ) }
							value={ priceText }
							onChange={ ( val ) =>
					...
					<PanelBody
						title={ __( 'Room Title', 'twork-builder' ) }
						initialOpen={ false }
					>
						<PanelColorSettings
					...
					<PanelBody
						title={ __( 'Amenities', 'twork-builder' ) }
						initialOpen={ false }
					>
						<BaseControl
							label={ __( 'Amenity Items', 'twork-builder' ) }
						>
							{ amenities.map( ( item ) => (
								<div
									key={ item.id }
					...
					<PanelBody
						title={ __( 'Details Padding', 'twork-builder' ) }
						initialOpen={ false }
					>
						<RangeControl
							label={ __(
