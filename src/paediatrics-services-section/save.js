...
export default function save({ attributes }) {
    ...
    const blockProps = useBlockProps.save({
        className: 'paed-section paed-services-section twork-paed-services-section',
        style: {
                    ...
                    <div className="paed-header paed-fade-up" style={{ marginBottom: '60px' }}>
                        {sectionTitle && (
                            <RichText.Content
                                ...
                                value={sectionTitle}
                                style={{
                                    fontSize: `${Number(sectionTitleFontSize)}rem`,
                        ...
                        {sectionSubtitle && (
                            <RichText.Content
                                ...
                                style={{
                                    fontSize: `${Number(sectionSubtitleFontSize)}rem`,
