    ...
    return (
        <>
            <InspectorControls>
                ...
                >
                    ...
                    {imageUrl && (
                        <TextControl
                            ...
                            help={__('Describe the image for accessibility and SEO.', 'twork-builder')}
                        />
                    )}
                </PanelBody>
                ...
                >
                    <TextControl
                        label={__('Tag / Category Label', 'twork-builder')}
                        value={tag}
                        onChange={(val) => setAttributes({ tag: val })}
                        help={__('Short label such as Immunology, Hematology, etc.', 'twork-builder')}
                    />
                    ...
                    {bullets && bullets.length > 0 && bullets.map((item, index) => (
                        <div
                            key={index}
                            style={{
                                display: 'flex',
                        ...
                        >
                            <TextControl
                                ...
                                placeholder={__('Bullet text…', 'twork-builder')}
                            />
                            <Button
                                isSmall
                                isSecondary
                                ...
                                icon="no-alt"
                                label={__('Remove bullet', 'twork-builder')}
                            />
                        </div>
                    ))}
            ...
            <div {...blockProps}>
                ...
                <div className="lab-tech-content">
                    ...
                    <RichText
                        ...
                        value={title}
                        onChange={(val) => setAttributes({ title: val })}
                        placeholder={__('Technology title…', 'twork-builder')}
                    ...
                    <RichText
                        ...
                        placeholder={__('Short description of the equipment…', 'twork-builder')}
