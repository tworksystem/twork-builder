    ...
    return (
        <>
            <InspectorControls>
                ...
                <PanelBody title={__('Checklist Items', 'twork-builder')} initialOpen={false}>
                    ...
                    <PanelColorSettings
                        ...
                        colorSettings={[
                            { value: listItemColor, onChange: (val) => setAttributes({ listItemColor: val }), label: __('Text Color', 'twork-builder') },
            ...
            <div {...blockProps}>
                ...
                {listItems.length > 0 && (
                    <ul className="process-list" style={{ textAlign: 'left', padding: 0, margin: 0, listStyle: 'none' }}>
                        {listItems.map((item) => (
                            <li
                                key={item.id}
                                style={{
                            ...
                            >
                                <i className="fas fa-check-circle" style={{ color: iconColor, marginRight: '10px', marginTop: '4px', flexShrink: 0 }} aria-hidden="true" />
                                <span>{item.text}</span>
                            </li>
                        ))}
                    </ul>
