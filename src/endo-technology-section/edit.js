...
const ALLOWED_BLOCKS = [ 'twork/endo-tech-item' ];
...
const TEMPLATE = [
	[
		'twork/endo-tech-item',
		{
			stageIndex: 0,
			hudLabel: '4K Ultra-HD Imaging',
			imageUrl: IMG_0,
			imageAlt: '4K endoscopy tower',
			itemNumber: '01',
	...
	[
		...
		{
			stageIndex: 1,
			hudLabel: 'AI Polyp Detection',
			imageUrl: IMG_1,
			imageAlt: 'AI-assisted polyp detection',
			itemNumber: '02',
			title: 'AI-Assisted Polyp Detection',
			description:
	...
	const stageItems = useSelect(
		( select ) => {
			...
			return getBlocks( clientId )
				.filter(
					( block ) =>
						block.name === 'twork/endo-tech-item' &&
