            ...
            <InspectorControls>
                ...
                >
                    ...
                    <RangeControl
                        ...
                        max={4}
                        step={1}
                        help={__('Number of columns on tablet screens', 'twork-builder')}
                    />
                    ...
                    <RangeControl
                        ...
                        max={2}
                        step={1}
                        help={__('Number of columns on mobile screens', 'twork-builder')}
                    />
                                ...
                                colorSettings={[
                                    {
                                        ...
                                        onChange: (val) => setAttributes({ cardBoxShadowColor: val }),
                ...
                >
                    ...
                    {hoverEffect && (
                        <>
                            ...
                            <RangeControl
                                label={__('Shadow Intensity', 'twork-builder')}
                                value={hoverShadowIntensity}
                                onChange={(val) => setAttributes({ hoverShadowIntensity: val })}
                                min={1}
                                max={3}
                                step={0.1}
                            />
