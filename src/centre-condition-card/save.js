...
function ConditionCardIconOutput({ iconType, faClass, dashicon, imageUrl, videoUrl, className = '' }) {
    const wrap = (content) => (
...
export default function save({ attributes }) {
    const { iconClass, iconType, iconDashicon, iconImageUrl, iconVideoUrl, title } = attributes;
