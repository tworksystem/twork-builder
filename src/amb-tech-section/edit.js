	...
	const TEMPLATE = [
		[
			'twork/amb-tech-item',
			{
				icon: 'fa-heartbeat',
				title: 'Defibrillator',
				description: 'Immediate response for cardiac arrest patients.',
			},
		],
		...
		[
			...
			{
				icon: 'fa-lungs',
				title: 'Mobile Ventilator',
				description:
					'Respiratory support for critical breathing issues.',
			},
		],
		...
		[
			'twork/amb-tech-item',
			{
				...
				title: 'GPS Tracking',
				description: 'Real-time location sharing with the hospital ER.',
			},
		],
		...
		[
			'twork/amb-tech-item',
			{
				...
				title: 'Trauma Kit',
				description:
					'Comprehensive supplies for accident stabilization.',
			},
		],
	];
		...
		<>
			{ isSelected && (
				<InspectorControls>
					...
					<PanelBody
						title={ __( 'Section Style', 'twork-builder' ) }
						initialOpen={ false }
					>
						<PanelColorSettings
						...
						<RangeControl
							...
							step={ 10 }
							help={ __(
								'Negative value overlaps previous section',
								'twork-builder'
							) }
						/>
					...
					>
						<RangeControl
							...
							step={ 10 }
							help={ __(
								'Min width per item (auto-fit grid)',
								'twork-builder'
							) }
						/>
			...
			<div { ...blockProps }>
				<div style={ containerStyle }>
					...
					>
						{ __(
							'Ambulance Tech Section (ICU on Wheels)',
							'twork-builder'
						) }
					</div>
