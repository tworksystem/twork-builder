...
export default function Edit({ attributes, setAttributes }) {
    const { imageUrl, imageId, imageAlt, name, specialization, profileUrl, profileLinkText } = attributes;
    const blockProps = useBlockProps({
        className: 'doctor-card-mini stagger-doc twork-centre-doctor-card-editor',
    });

    return (
        <>
            <InspectorControls>
                <PanelBody title={__('Doctor', 'twork-builder')} initialOpen={true}>
                    {!imageUrl ? (
                        <MediaPlaceholder
                        ...
                        <div>
                            ...
                            <TextControl
                                ...
                                help={__('Accessibility; e.g. doctor name', 'twork-builder')}
                            />
                    ...
                    <TextControl
                        ...
                        onChange={(v) => setAttributes({ specialization: v })}
                    />
                    <TextControl
                    ...
                    <TextControl
                        ...
                        onChange={(v) => setAttributes({ profileLinkText: v })}
                    />
                </PanelBody>
            </InspectorControls>
            <div {...blockProps}>
                ...
                <div className="doc-info">
                    ...
                    <br />
                    <a href={profileUrl || '#'} className="btn-outline-dark" onClick={(e) => e.preventDefault()} role="presentation" aria-label={profileLinkText ? undefined : __('View profile', 'twork-builder')}>
