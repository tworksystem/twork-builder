...
const TEMPLATE = [
    ['twork/phy-journey-step', {
        ...
        description: 'Comprehensive evaluation of your posture, movement, and pain points by our senior physiotherapists.',
    }],
    ['twork/phy-journey-step', {
        title: '2. Treatment Plan',
        description: 'We design a personalized roadmap combining manual therapy, machines, and exercises.',
    }],
    ['twork/phy-journey-step', {
        title: '3. Active Rehab',
        description: 'Guided sessions in our gym to strengthen muscles and improve flexibility.',
    }],
    ['twork/phy-journey-step', {
        title: '4. Maintenance',
        description: 'Home exercise programs to prevent future injuries and maintain health.',
    }],
];
                        ...
                        >
                            {showSectionTitle && (
                                <RichText
                                    ...
                                    placeholder={__('Your Road to Recovery', 'twork-builder')}
                                />
                            )}
                            {showSectionSubtitle && (
                                <RichText
                                    ...
                                    placeholder={__('A structured approach to getting you back to 100%.', 'twork-builder')}
                                />
                            )}
                        </div>
                    )}

                    <div className={`phy-journey-container ${animationOnScroll ? 'stagger-up' : ''}`}>
                        <InnerBlocks
