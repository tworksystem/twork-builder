            ...
            <InspectorControls>
                ...
                >
                    ...
                    {backgroundImage && (
                        <>
                            ...
                            <RangeControl
                                label={__('Background Position X (%)', 'twork-builder')}
                                value={backgroundPositionX}
                                onChange={(val) => setAttributes({ backgroundPositionX: val })}
                                min={0}
                                max={100}
                                step={1}
                                help={__('Horizontal position of the background image', 'twork-builder')}
                            />

                            <RangeControl
                                label={__('Background Position Y (%)', 'twork-builder')}
                                value={backgroundPositionY}
                                onChange={(val) => setAttributes({ backgroundPositionY: val })}
                                min={0}
                                max={100}
                                step={1}
                                help={__('Vertical position of the background image', 'twork-builder')}
                            />
                        </>
                    )}
                    ...
                    <RangeControl
                        ...
                        max={800}
                        step={10}
                        help={__('Minimum height on desktop screens', 'twork-builder')}
                    />
                    ...
                    <RangeControl
                        ...
                        max={600}
                        step={10}
                        help={__('Minimum height on mobile screens', 'twork-builder')}
                    />
                </PanelBody>
                ...
                >
                    ...
                    {showOverlay && (
                        <>
                            ...
                            <ToggleControl
                                label={__('Gradient Overlay', 'twork-builder')}
                                checked={overlayGradient}
                                onChange={(val) => setAttributes({ overlayGradient: val })}
                                help={__('Apply gradient effect to overlay', 'twork-builder')}
                            />
                        </>
                    )}
                </PanelBody>
                ...
                >
                    ...
                    <ToggleControl
                        ...
                        onChange={(val) => setAttributes({ headingTextShadow: val })}
                        help={__('Add shadow effect to heading text', 'twork-builder')}
                    />
                </PanelBody>
                ...
                >
                    <RangeControl
                        ...
                        max={1600}
                        step={50}
                        help={__('Maximum width of the content container', 'twork-builder')}
                    />

                    <RangeControl
                        label={__('Content Padding - Desktop (px)', 'twork-builder')}
                    ...
                    <RangeControl
                        label={__('Content Padding - Mobile (px)', 'twork-builder')}
                ...
                >
                    <ToggleControl
                        ...
                        checked={showShape}
                        onChange={(val) => setAttributes({ showShape: val })}
                    />

                    {showShape && (
                        <>
                            <BaseControl label={__('Shape Image', 'twork-builder')}>
                                {!shapeImage ? (
                                    <MediaPlaceholder
                                        onSelect={(media) => setAttributes({
                                        ...
                                        allowedTypes={['image']}
                                        multiple={false}
                                        labels={{ title: __('Shape Image', 'twork-builder') }}
                                    />
                                ) : (
                                    <div>
                                        <img
                            ...
                            <SelectControl
                                label={__('Shape Position', 'twork-builder')}
                                value={shapePosition}
                                options={[
                                    { label: __('Bottom', 'twork-builder'), value: 'bottom' },
                                    { label: __('Top', 'twork-builder'), value: 'top' }
                                ]}
                                onChange={(val) => setAttributes({ shapePosition: val })}
                            />

                            <SelectControl
                                label={__('Shape Background Size', 'twork-builder')}
                                ...
                                onChange={(val) => setAttributes({ shapeBackgroundSize: val })}
                            />

                            <RangeControl
                                label={__('Shape Height - Desktop (px)', 'twork-builder')}
                                value={shapeHeight}
                                onChange={(val) => setAttributes({ shapeHeight: val })}
                                min={50}
                                max={300}
                                step={10}
                            />
                            ...
                            <RangeControl
                                label={__('Shape Height - Mobile (px)', 'twork-builder')}
                                value={shapeHeightMobile}
                                onChange={(val) => setAttributes({ shapeHeightMobile: val })}
                                min={30}
                                max={200}
                                step={10}
                            />
                ...
                <div style={containerStyle}>
                    ...
                    >
                        <RichText
                            ...
                            value={bannerHeading}
                            onChange={(value) => setAttributes({ bannerHeading: value })}
                            placeholder={__('Enter banner heading...', 'twork-builder')}
                            style={{
                                color: headingColor,
                                fontSize: `${headingFontSize}rem`,
                                fontWeight: headingFontWeight,
                                textShadow: headingTextShadow ? '2px 2px 4px rgba(0, 0, 0, 0.3)' : 'none'
                            }}
                        ...
                        {bannerDescription && (
                            <RichText
                                ...
                                placeholder={__('Enter banner description...', 'twork-builder')}
                                style={{
                                    color: descriptionColor,
                                    fontSize: `${descriptionFontSize}rem`,
                                    lineHeight: descriptionLineHeight
                                }}
                                data-font-size-mobile={descriptionFontSizeMobile}
                            />
                        )}
                    </div>
                </div>
                ...
                {showShape && shapeImage && (
                    <div
                        ...
                        style={{
                            ...
                            backgroundRepeat: 'no-repeat',
                            backgroundPosition: shapePosition === 'bottom' ? 'bottom' : 'top',
