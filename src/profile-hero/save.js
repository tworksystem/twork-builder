                ...
                <div className="profile-img-box animate-item">
                    ...
                    {showBadge && badgeText && (
                        <span className="profile-badge">
                            <i className={badgeIcon} aria-hidden="true" /> {badgeText}
                        </span>
                    )}
                </div>
                        ...
                        <div className="profile-specs">
                            {safeSpecItems.map((item) => (
                                <div key={item.id} className="spec-item">
                                    <i className={item.iconClass || 'fas fa-check'} aria-hidden="true" /> {item.text || ''}
                                </div>
                            ))}
                        </div>
                    )}
                    ...
                    <div className="profile-actions">
                        {primaryButtonText && (
                            <a
                                ...
                                target={primaryButtonTarget ? '_blank' : undefined}
                                rel={primaryButtonTarget ? 'noopener noreferrer' : undefined}
                            >
                                {primaryButtonText}
                            </a>
                        )}
                        {secondaryButtonText && (
                            <a
                                ...
                                target={secondaryButtonTarget ? '_blank' : undefined}
                                rel={secondaryButtonTarget ? 'noopener noreferrer' : undefined}
                            >
                                {secondaryButtonText}
                            </a>
                        )}
