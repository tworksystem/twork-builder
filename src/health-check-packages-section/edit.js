...
export default function Edit( { attributes, setAttributes, isSelected } ) {
	...
	const blockProps = useStableBlockProps(
		() => ( {
			className: 'chk-section mk-health-check-packages-section-editor',
			style: {
		...
		<>
			{ isSelected && (
				<InspectorControls>
					...
					>
						{ tabs.map( ( tab, index ) => (
							...
							>
								...
								<TextControl
									...
									value={ tab.value }
									onChange={ ( v ) =>
										updateTab( index, 'value', v )
									}
									help={ __(
										'Must match category on cards: e.g. basic, special, gender',
										'twork-builder'
									) }
								/>
						...
						<Button isSecondary isSmall onClick={ addTab }>
			...
			<section { ...blockProps } id="packages">
				<div className="chk-container" style={ containerStyle }>
					...
					<div
						className="chk-tabs-wrapper fade-up"
					...
					<div
						className="chk-pkg-grid mk-chk-pkg-grid-editor"
						data-active="basic"
						style={ {
							display: 'grid',
							gridTemplateColumns:
