(function () {
    ...
    const initCsrInitiatives = () => {
        if (!('IntersectionObserver' in window)) {
            document.querySelectorAll('.twork-csr-initiatives-section .initiative-card').forEach((card) => {
        ...
        const sections = document.querySelectorAll('.twork-csr-initiatives-section');
