/**
 * Laparoscopy stats strip — count-up animation (vanilla, no GSAP).
 */
( function () {
	'use strict';

	const SECTION_SELECTOR = '.twork-laparo-stats-section';
	...
	function animateCount( el ) {
		if ( el.dataset.laparoCountDone === '1' ) {
			return;
		}
		el.dataset.laparoCountDone = '1';
	...
	if ( document.readyState === 'loading' ) {
		document.addEventListener( 'DOMContentLoaded', initLaparoStats );
	} else {
		initLaparoStats();
	}
} )();
