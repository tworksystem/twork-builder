...
function buildTemplate( data ) {
	...
	const priceBlock =
		product.salePrice != null
			? `<span class="deal-of-day__sale" data-field="salePrice">${ formatCurrency(
					product.salePrice
			  ) }</span>
         <span class="deal-of-day__price" data-field="price">${ formatCurrency(
				product.price
			) }</span>`
			: `<span class="deal-of-day__sale" data-field="price">${ formatCurrency(
					product.price
			  ) }</span>`;
    ...
    <div class="deal-of-day__inner l-section">
      ...
      <article class="deal-of-day__product" data-item-id="${
        ...
        <div class="deal-of-day__body">
          <h3 class="deal-of-day__name" data-field="name">${
				product.name || ''
			}</h3>
