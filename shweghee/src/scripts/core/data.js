...
const FALLBACK_SHOP_DATA = {
	...
	footer: {
		...
		phone: '095-2-55122',
		copyright:
			'© 2026 Shwe Myanmar Foodstuff Industry. All rights reserved.',
	},
};
...
const FALLBACK_PAGES_DATA = {
	...
	whereToBuy: {
		...
		whereToBuy: {
			...
			paragraphs: [
				'Contact 095-2-55122 for nearest outlet information.',
			],
	...
	faq: {
		pageHero: {
			title: 'FAQ',
			subtitle: 'Common questions about Shwe Myanmar products.',
		},
		breadcrumb: {
			items: [
				{ id: 'home', label: 'Home', href: '/pages/home.html' },
	...
	careers: {
		...
		careers: {
			...
			paragraphs: [
				'Contact us for current openings at our Mandalay facility.',
			],
			benefits: [],
			positions: [],
			...
			sections: [
				{
					...
					open: true,
					paragraphs: [
						'We are committed to improving website accessibility for all visitors.',
					],
				},
			],
		},
	...
	about: {
		pageHero: {
			...
			title: 'About Us',
			subtitle:
				'Mandalay heritage, natural ingredients, and trusted quality.',
		},
		breadcrumb: {
			items: [
				{ id: 'home', label: 'Home', href: '/pages/home.html' },
		...
		aboutStory: {
			...
			paragraphs: [
				'Shwe Myanmar (ရွှေမြန်မာ) is a registered trademark of Shwe Myanmar Foodstuff Industry, proudly based in Mandalay, Myanmar.',
			],
			ctaLabel: 'VIEW OUR PRODUCTS',
			ctaHref: '/pages/shop.html',
			imageUrl:
				'https://images.unsplash.com/photo-1486297678162-eb2a19b0a32d?w=560&h=400&fit=crop&q=80',
